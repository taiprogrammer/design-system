...
var require_babel = __commonJS({
  "../../node_modules/prettier/plugins/babel.js"(exports, module) {
    (function(f) {
      ...
      var ji = Object.getPrototypeOf, $i = Object.prototype.hasOwnProperty;
      var ls = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports), Vi = (a, t) => {
        for (var e in t)
          Re(a, e, { get: t[e], enumerable: true });
      }, cs = (a, t, e, s) => {
        if (t && typeof t == "object" || typeof t == "function")
          for (let i of Ui(t))
            !$i.call(a, i) && i !== e && Re(a, i, { get: () => t[i], enumerable: !(s = Ri(t, i)) || s.enumerable });
        return a;
      };
      var ct = (a, t, e) => (e = a != null ? _i(ji(a)) : {}, cs(t || !a || !a.__esModule ? Re(e, "default", { value: a, enumerable: true }) : e, a)), Ki = (a) => cs(Re({}, "__esModule", { value: true }), a);
      var is = ls((De) => {
        "use strict";
...
- Did you mean \`import { "${a}" as foo }\`?`, ImportCallArgumentTrailingComma: "Trailing comma is disallowed inside import(...) arguments.", ImportCallArity: ({ maxArgumentCount: a }) => `\`import()\` requires exactly ${a === 1 ? "one argument" : "one or two arguments"}.`, ImportCallNotNewExpression: "Cannot use new with import(...).", ImportCallSpreadArgument: "`...` is not allowed in `import()`.", ImportJSONBindingNotDefault: "A JSON module can only be imported with `default`.", ImportReflectionHasAssertion: "`import module x` cannot have assertions.", ImportReflectionNotBinding: 'Only `import module x from "./module"` is valid.', IncompatibleRegExpUVFlags: "The 'u' and 'v' regular expression flags cannot be enabled at the same time.", InvalidBigIntLiteral: "Invalid BigIntLiteral.", InvalidCodePoint: "Code point out of bounds.", InvalidCoverInitializedName: "Invalid shorthand property initializer.", InvalidDecimal: "Invalid decimal.", InvalidDigit: ({ radix: a }) => `Expected number in radix ${a}.`, InvalidEscapeSequence: "Bad character escape sequence.", InvalidEscapeSequenceTemplate: "Invalid escape sequence in template.", InvalidEscapedReservedWord: ({ reservedWord: a }) => `Escape sequence in keyword ${a}.`, InvalidIdentifier: ({ identifierName: a }) => `Invalid identifier ${a}.`, InvalidLhs: ({ ancestor: a }) => `Invalid left-hand side in ${Pt(a)}.`, InvalidLhsBinding: ({ ancestor: a }) => `Binding invalid left-hand side in ${Pt(a)}.`, InvalidNumber: "Invalid number.", InvalidOrMissingExponent: "Floating-point numbers require a valid exponent after the 'e'.", InvalidOrUnexpectedToken: ({ unexpected: a }) => `Unexpected character '${a}'.`, InvalidParenthesizedAssignment: "Invalid parenthesized assignment pattern.", InvalidPrivateFieldResolution: ({ identifierName: a }) => `Private name #${a} is not defined.`, InvalidPropertyBindingPattern: "Binding member expression.", InvalidRecordProperty: "Only properties and spread elements are allowed in record definitions.", InvalidRestAssignmentPattern: "Invalid rest operator's argument.", LabelRedeclaration: ({ labelName: a }) => `Label '${a}' is already declared.`, LetInLexicalBinding: "'let' is not allowed to be used as a name in 'let' or 'const' declarations.", LineTerminatorBeforeArrow: "No line break is allowed before '=>'.", MalformedRegExpFlags: "Invalid regular expression flag.", MissingClassName: "A class name is required.", MissingEqInAssignment: "Only '=' operator can be used for specifying default value.", MissingSemicolon: "Missing semicolon.", MissingPlugin: ({ missingPlugin: a }) => `This experimental syntax requires enabling the parser plugin: ${a.map((t) => JSON.stringify(t)).join(", ")}.`, MissingOneOfPlugins: ({ missingPlugin: a }) => `This experimental syntax requires enabling one of the following parser plugin(s): ${a.map((t) => JSON.stringify(t)).join(", ")}.`, MissingUnicodeEscape: "Expecting Unicode escape sequence \\uXXXX.", MixingCoalesceWithLogical: "Nullish coalescing operator(??) requires parens when mixing with logical operators.", ModuleAttributeDifferentFromType: "The only accepted module attribute is `type`.", ModuleAttributeInvalidValue: "Only string literals are allowed as module attribute values.", ModuleAttributesWithDuplicateKeys: ({ key: a }) => `Duplicate key "${a}" is not allowed in module attributes.`, ModuleExportNameHasLoneSurrogate: ({ surrogateCharCode: a }) => `An export name cannot include a lone surrogate, found '\\u${a.toString(16)}'.`, ModuleExportUndefined: ({ localName: a }) => `Export '${a}' is not defined.`, MultipleDefaultsInSwitch: "Multiple default clauses.", NewlineAfterThrow: "Illegal newline after throw.", NoCatchOrFinally: "Missing catch or finally clause.", NumberIdentifier: "Identifier directly after number.", NumericSeparatorInEscapeSequence: "Numeric separators are not allowed inside unicode escape sequences or hex escape sequences.", ObsoleteAwaitStar: "'await*' has been removed from the async functions proposal. Use Promise.all() instead.", OptionalChainingNoNew: "Constructors in/after an Optional Chain are not allowed.", OptionalChainingNoTemplate: "Tagged Template Literals are not allowed in optionalChain.", OverrideOnConstructor: "'override' modifier cannot appear on a constructor declaration.", ParamDupe: "Argument name clash.", PatternHasAccessor: "Object pattern can't contain getter or setter.", PatternHasMethod: "Object pattern can't contain methods.", PrivateInExpectedIn: ({ identifierName: a }) => `Private names are only allowed in property accesses (\`obj.#${a}\`) or in \`in\` expressions (\`#${a} in obj\`).`, PrivateNameRedeclaration: ({ identifierName: a }) => `Duplicate private name #${a}.`, RecordExpressionBarIncorrectEndSyntaxType: "Record expressions ending with '|}' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", RecordExpressionBarIncorrectStartSyntaxType: "Record expressions starting with '{|' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", RecordExpressionHashIncorrectStartSyntaxType: "Record expressions starting with '#{' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'hash'.", RecordNoProto: "'__proto__' is not allowed in Record expressions.", RestTrailingComma: "Unexpected trailing comma after rest element.", SloppyFunction: "In non-strict mode code, functions can only be declared at top level or inside a block.", SloppyFunctionAnnexB: "In non-strict mode code, functions can only be declared at top level, inside a block, or as the body of an if statement.", StaticPrototype: "Classes may not have static property named prototype.", SuperNotAllowed: "`super()` is only valid inside a class constructor of a subclass. Maybe a typo in the method name ('constructor') or not extending another class?", SuperPrivateField: "Private fields can't be accessed on super.", TrailingDecorator: "Decorators must be attached to a class element.", TupleExpressionBarIncorrectEndSyntaxType: "Tuple expressions ending with '|]' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", TupleExpressionBarIncorrectStartSyntaxType: "Tuple expressions starting with '[|' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", TupleExpressionHashIncorrectStartSyntaxType: "Tuple expressions starting with '#[' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'hash'.", UnexpectedArgumentPlaceholder: "Unexpected argument placeholder.", UnexpectedAwaitAfterPipelineBody: 'Unexpected "await" after pipeline body; await must have parentheses in minimal proposal.', UnexpectedDigitAfterHash: "Unexpected digit after hash token.", UnexpectedImportExport: "'import' and 'export' may only appear at the top level.", UnexpectedKeyword: ({ keyword: a }) => `Unexpected keyword '${a}'.`, UnexpectedLeadingDecorator: "Leading decorators must be attached to a class declaration.", UnexpectedLexicalDeclaration: "Lexical declaration cannot appear in a single-statement context.", UnexpectedNewTarget: "`new.target` can only be used in functions or class properties.", UnexpectedNumericSeparator: "A numeric separator is only allowed between two digits.", UnexpectedPrivateField: "Unexpected private name.", UnexpectedReservedWord: ({ reservedWord: a }) => `Unexpected reserved word '${a}'.`, UnexpectedSuper: "'super' is only allowed in object methods and classes.", UnexpectedToken: ({ expected: a, unexpected: t }) => `Unexpected token${t ? ` '${t}'.` : ""}${a ? `, expected "${a}"` : ""}`, UnexpectedTokenUnaryExponentiation: "Illegal expression. Wrap left hand side or entire exponentiation in parentheses.", UnexpectedUsingDeclaration: "Using declaration cannot appear in the top level when source type is `script`.", UnsupportedBind: "Binding should be performed on object property.", UnsupportedDecoratorExport: "A decorated export must export a class declaration.", UnsupportedDefaultExport: "Only expressions, functions or classes are allowed as the `default` export.", UnsupportedImport: "`import` can only be used in `import()` or `import.meta`.", UnsupportedMetaProperty: ({ target: a, onlyValidPropertyName: t }) => `The only valid meta property for ${a} is ${a}.${t}.`, UnsupportedParameterDecorator: "Decorators cannot be used to decorate parameters.", UnsupportedPropertyDecorator: "Decorators cannot be used to decorate object literal properties.", UnsupportedSuper: "'super' can only be used with function calls (i.e. super()) or in property accesses (i.e. super.prop or super[prop]).", UnterminatedComment: "Unterminated comment.", UnterminatedRegExp: "Unterminated regular expression.", UnterminatedString: "Unterminated string constant.", UnterminatedTemplate: "Unterminated template.", UsingDeclarationHasBindingPattern: "Using declaration cannot have destructuring patterns.", VarRedeclaration: ({ identifierName: a }) => `Identifier '${a}' has already been declared.`, YieldBindingIdentifier: "Can not use 'yield' as identifier inside a generator.", YieldInParameter: "Yield expression is not allowed in formal parameters.", ZeroDigitNumericSeparator: "Numeric separator can not be used after leading 0." }, Ji = { StrictDelete: "Deleting local variable in strict mode.", StrictEvalArguments: ({ referenceName: a }) => `Assigning to '${a}' in strict mode.`, StrictEvalArgumentsBinding: ({ bindingName: a }) => `Binding '${a}' in strict mode.`, StrictFunction: "In strict mode code, functions can only be declared at top level or inside a block.", StrictNumericEscape: "The only valid numeric escape in strict mode is '\\0'.", StrictOctalLiteral: "Legacy octal literals are not allowed in strict mode.", StrictWith: "'with' in strict mode." }, Xi = /* @__PURE__ */ new Set(["ArrowFunctionExpression", "AssignmentExpression", "ConditionalExpression", "YieldExpression"]), Gi = { PipeBodyIsTighter: "Unexpected yield after pipeline body; any yield expression acting as Hack-style pipe body must be parenthesized due to its loose operator precedence.", PipeTopicRequiresHackPipes: 'Topic reference is used, but the pipelineOperator plugin was not passed a "proposal": "hack" or "smart" option.', PipeTopicUnbound: "Topic reference is unbound; it must be inside a pipe body.", PipeTopicUnconfiguredToken: ({ token: a }) => `Invalid topic token ${a}. In order to use ${a} as a topic reference, the pipelineOperator plugin must be configured with { "proposal": "hack", "topicToken": "${a}" }.`, PipeTopicUnused: "Hack-style pipe body does not contain a topic reference; Hack-style pipes must use topic at least once.", PipeUnparenthesizedBody: ({ type: a }) => `Hack-style pipe body cannot be an unparenthesized ${Pt({ type: a })}; please wrap it in parentheses.`, PipelineBodyNoArrow: 'Unexpected arrow "=>" after pipeline body; arrow function in pipeline body must be parenthesized.', PipelineBodySequenceExpression: "Pipeline body may not be a comma-separated sequence expression.", PipelineHeadSequenceExpression: "Pipeline head should not be a comma-separated sequence expression.", PipelineTopicUnused: "Pipeline is in topic style but does not use topic reference.", PrimaryTopicNotAllowed: "Topic reference was used in a lexical context without topic binding.", PrimaryTopicRequiresSmartPipeline: 'Topic reference is used, but the pipelineOperator plugin was not passed a "proposal": "hack" or "smart" option.' }, Yi = ["toMessage"], Qi = ["message"];
        ...
        function V(a, t) {
          ...
          for (let s of Object.keys(a)) {
            let i = a[s], r = typeof i == "string" ? { message: () => i } : typeof i == "function" ? { message: i } : i, { message: n } = r, o = He(r, Qi), h = typeof n == "string" ? () => n : n;
            e[s] = Zi(Object.assign({ code: xt.SyntaxError, reasonCode: s, toMessage: h }, t ? { syntaxPlugin: t } : {}, o));
          }
          return e;
        }
        var p = Object.assign({}, V(Hi), V(Wi), V(Ji), V`pipelineOperator`(Gi)), { defineProperty: er } = Object, us = (a, t) => er(a, t, { enumerable: false, value: a[t] });
        function be(a) {
          return a.loc.start && us(a.loc.start, "index"), a.loc.end && us(a.loc.end, "index"), a;
        }
        var tr = (a) => class extends a {
          parse() {
            let e = be(super.parse());
            return this.options.tokens && (e.tokens = e.tokens.map(be)), e;
          }
          ...
          finishNodeAt(e, s, i) {
            return be(super.finishNodeAt(e, s, i));
          }
          resetStartLocation(e, s) {
            super.resetStartLocation(e, s), be(e);
          }
          resetEndLocation(e, s = this.state.lastTokEndLoc) {
            super.resetEndLocation(e, s), be(e);
          }
        }, Q = class {
          constructor(t, e) {
            this.token = void 0, this.preserveSpace = void 0, this.token = t, this.preserveSpace = !!e;
          }
        }, E = { brace: new Q("{"), j_oTag: new Q("<tag"), j_cTag: new Q("</tag"), j_expr: new Q("<tag>...</tag>", true) };
        E.template = new Q("`", true);
        var g = true, m = true, pt = true, Ae = true, q = true, sr = true, We = class {
          constructor(t, e = {}) {
        ...
        j[8].updateContext = (a) => {
          a.pop();
        }, j[5].updateContext = j[7].updateContext = j[23].updateContext = (a) => {
          a.push(E.brace);
        ...
        function $(a) {
          return a < 65 ? a === 36 : a <= 90 ? true : a < 97 ? a === 95 : a <= 122 ? true : a <= 65535 ? a >= 170 && fr.test(String.fromCharCode(a)) : gt(a, vs);
        }
        function he(a) {
          return a < 48 ? a === 36 : a < 58 ? true : a < 65 ? false : a <= 90 ? true : a < 97 ? a === 95 : a <= 122 ? true : a <= 65535 ? a >= 170 && mr.test(String.fromCharCode(a)) : gt(a, vs) || gt(a, yr);
        }
        var Gt = { keyword: ["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete"], strict: ["implements", "interface", "let", "package", "private", "protected", "public", "static", "yield"], strictBind: ["eval", "arguments"] }, xr = new Set(Gt.keyword), Pr = new Set(Gt.strict), Tr = new Set(Gt.strictBind);
        function Ls(a, t) {
          return t && a === "await" || a === "enum";
        }
        function Ds(a, t) {
          return Ls(a, t) || Pr.has(a);
        }
        function Ms(a) {
          return Tr.has(a);
        }
        ...
        var Ar = /* @__PURE__ */ new Set(["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete", "implements", "interface", "let", "package", "private", "protected", "public", "static", "yield", "eval", "arguments", "enum", "await"]);
        function Sr(a) {
          return Ar.has(a);
        }
        var ae = 0, ne = 1, K = 2, Yt = 4, Bs = 8, Xe = 16, Fs = 32, Z = 64, Ge = 128, le = 256, Ue = ne | K | Ge | le, F = 1, te = 2, _s = 4, ee = 8, Ke = 16, Rs = 64, Ye = 128, bt = 256, At = 512, Qt = 1024, St = 2048, Ie = 4096, st = 8192, Us = F | te | ee | Ye | st, ce = F | 0 | ee | st, Er = F | 0 | ee | 0, Qe = F | 0 | _s | 0, js = F | 0 | Ke | 0, Cr = 0 | te | 0 | Ye, wr = 0 | te | 0 | 0, $s = F | te | ee | bt | st, fs = 0 | Qt, W = 0 | Rs, Ir = F | 0 | 0 | Rs, Nr = $s | At, kr = 0 | Qt, ms = 0 | te | 0 | Ie, vr = St, Ze = 4, Zt = 2, es = 1, ut = Zt | es, Lr = Zt | Ze, Dr = es | Ze, Mr = Zt, Or = es, dt = 0, ke = class {
          constructor(t) {
          ...
          get inFunction() {
            return (this.currentVarScopeFlags() & K) > 0;
          }
          get allowSuper() {
            return (this.currentThisScopeFlags() & Xe) > 0;
          }
          get allowDirectSuper() {
            return (this.currentThisScopeFlags() & Fs) > 0;
          }
          get inClass() {
          ...
          get inNonArrowFunction() {
            return (this.currentThisScopeFlags() & K) > 0;
          }
          ...
          treatFunctionsAsVarInScope(t) {
            return !!(t.flags & (K | Ge) || !this.parser.inModule && t.flags & ne);
          }
          declareName(t, e, s) {
            let i = this.currentScope();
            if (e & ee || e & Ke)
              this.checkRedeclarationInScope(i, t, e, s), e & Ke ? i.functions.add(t) : i.lexical.add(t), e & ee && this.maybeExportDefined(i, t);
            else if (e & _s)
              for (let r = this.scopeStack.length - 1; r >= 0 && (i = this.scopeStack[r], this.checkRedeclarationInScope(i, t, e, s), i.var.add(t), this.maybeExportDefined(i, t), !(i.flags & Ue)); --r)
                ;
          ...
          isRedeclaredInScope(t, e, s) {
            return s & F ? s & ee ? t.lexical.has(e) || t.functions.has(e) || t.var.has(e) : s & Ke ? t.lexical.has(e) || !this.treatFunctionsAsVarInScope(t) && t.var.has(e) : t.lexical.has(e) && !(t.flags & Bs && t.lexical.values().next().value === e) || !this.treatFunctionsAsVarInScope(t) && t.functions.has(e) : false;
          }
          checkLocalExport(t) {
          ...
          isRedeclaredInScope(t, e, s) {
            return super.isRedeclaredInScope(t, e, s) ? true : s & St ? !t.declareFunctions.has(e) && (t.lexical.has(e) || t.functions.has(e)) : false;
          }
          checkLocalExport(t) {
        ...
        function Se(a, t, e) {
          ...
          for (; s === null && i > 0; )
            s = t[--i];
          s === null || s.start > e.start ? Le(a, e.comments) : Vs(s, e.comments);
        }
        var It = class extends wt {
          ...
          finalizeComment(t) {
            ...
            if (t.leadingNode !== null || t.trailingNode !== null)
              t.leadingNode !== null && Vs(t.leadingNode, e), t.trailingNode !== null && Br(t.trailingNode, e);
            else {
        ...
        var Nt = class a {
          ...
          return t >= 48 && t <= 57;
        }, xs = { decBinOct: /* @__PURE__ */ new Set([46, 66, 69, 79, 95, 98, 101, 111]), hex: /* @__PURE__ */ new Set([46, 88, 95, 120]) }, $e = { bin: (a) => a === 48 || a === 49, oct: (a) => a >= 48 && a <= 55, dec: (a) => a >= 48 && a <= 57, hex: (a) => a >= 48 && a <= 57 || a >= 65 && a <= 70 || a >= 97 && a <= 102 };
        function Ps(a, t, e, s, i, r) {
...
`);
            ...
            case 120: {
              let l;
              return { code: l, pos: t } = kt(a, t, e, s, 2, false, n, r), o(l === null ? null : String.fromCharCode(l));
            }
            case 117: {
              let l;
              return { code: l, pos: t } = qs(a, t, e, s, n, r), o(l === null ? null : String.fromCodePoint(l));
            }
            case 116:
              return o("	");
            case 98:
        ...
        function kt(a, t, e, s, i, r, n, o) {
          let h = t, l;
          return { n: l, pos: t } = zs(a, t, e, s, 16, i, r, false, o, !n), l === null && (n ? o.invalidEscapeSequence(h, e, s) : t = h - 1), { code: l, pos: t };
        }
        function zs(a, t, e, s, i, r, n, o, h, l) {
          let c = t, u = i === 16 ? xs.hex : xs.decBinOct, f = i === 16 ? $e.hex : i === 10 ? $e.dec : i === 8 ? $e.oct : $e.bin, d = false, x = 0;
          for (let I = 0, C = r ?? 1 / 0; I < C; ++I) {
            let w = a.charCodeAt(t), N;
            if (w === 95 && o !== "bail") {
              let _e = a.charCodeAt(t - 1), ge = a.charCodeAt(t + 1);
              if (o) {
                if (Number.isNaN(ge) || !f(ge) || u.has(_e) || u.has(ge)) {
                  if (l)
                    return { n: null, pos: t };
            ...
            if (w >= 97 ? N = w - 97 + 10 : w >= 65 ? N = w - 65 + 10 : _r(w) ? N = w - 48 : N = 1 / 0, N >= i) {
              if (N <= 9 && l)
                return { n: null, pos: t };
        ...
        function qs(a, t, e, s, i, r) {
          let n = a.charCodeAt(t), o;
          if (n === 123) {
            if (++t, { code: o, pos: t } = kt(a, t, e, s, a.indexOf("}", t) - t, true, i, r), ++t, o !== null && o > 1114111)
              if (i)
                r.invalidCodePoint(t, e, s);
              else
                return { code: null, pos: t };
          } else
            ({ code: o, pos: t } = kt(a, t, e, s, 4, false, i, r));
          return { code: o, pos: t };
        }
        var jr = ["at"], $r = ["at"];
        function Ee(a, t, e) {
        ...
        var Vr = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), O = class {
          constructor(t) {
            this.type = t.type, this.value = t.value, this.start = t.start, this.end = t.end, this.loc = new de(t.startLoc, t.endLoc);
          }
        }, vt = class extends It {
          constructor(t, e) {
            super(), this.isLookahead = void 0, this.tokens = [], this.errorHandlers_readInt = { invalidDigit: (s, i, r, n) => this.options.errorRecovery ? (this.raise(p.InvalidDigit, { at: Ee(s, i, r), radix: n }), true) : false, numericSeparatorInEscapeSequence: this.errorBuilder(p.NumericSeparatorInEscapeSequence), unexpectedNumericSeparator: this.errorBuilder(p.UnexpectedNumericSeparator) }, this.errorHandlers_readCodePoint = Object.assign({}, this.errorHandlers_readInt, { invalidEscapeSequence: this.errorBuilder(p.InvalidEscapeSequence), invalidCodePoint: this.errorBuilder(p.InvalidCodePoint) }), this.errorHandlers_readStringContents_string = Object.assign({}, this.errorHandlers_readCodePoint, { strictNumericEscape: (s, i, r) => {
              this.recordStrictModeErrors(p.StrictNumericEscape, { at: Ee(s, i, r) });
            }, unterminated: (s, i, r) => {
              throw this.raise(p.UnterminatedString, { at: Ee(s - 1, i, r) });
              ...
              throw this.raise(p.UnterminatedTemplate, { at: Ee(s, i, r) });
            } }), this.state = new Nt(), this.state.init(t), this.input = e, this.length = e.length, this.isLookahead = false;
          }
          pushToken(t) {
          ...
          nextTokenStartSince(t) {
            return ft.lastIndex = t, ft.test(this.input) ? ft.lastIndex : t;
          }
          lookaheadCharCode() {
          ...
          skipBlockComment(t) {
            ...
            for (this.state.pos = i + t.length, je.lastIndex = s + 2; je.test(this.input) && je.lastIndex <= i; )
              ++this.state.curLine, this.state.lineStart = je.lastIndex;
            if (this.isLookahead)
              return;
            let r = { type: "CommentBlock", value: this.input.slice(s + 2, i), start: s, end: i + t.length, loc: new de(e, this.state.curPosition()) };
          ...
          skipLineComment(t) {
            ...
            if (this.state.pos < this.length)
              for (; !Ne(i) && ++this.state.pos < this.length; )
                i = this.input.charCodeAt(this.state.pos);
            if (this.isLookahead)
              return;
            let r = this.state.pos, o = { type: "CommentLine", value: this.input.slice(e + t, r), start: e, end: r, loc: new de(s, this.state.curPosition()) };
          ...
          readToken_numberSign() {
            ...
            if (e === 123 || e === 91 && this.hasPlugin("recordAndTuple")) {
              ...
              $(e) ? (++this.state.pos, this.finishToken(136, this.readWord1(e))) : e === 92 ? (++this.state.pos, this.finishToken(136, this.readWord1())) : this.finishOp(27, 1);
          }
          readToken_dot() {
          ...
          readInt(t, e, s = false, i = true) {
            let { n: r, pos: n } = zs(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, e, s, i, this.errorHandlers_readInt, false);
          ...
          readNumber(t) {
            ...
            if (c === 46 && !h && (++this.state.pos, this.readInt(10), i = true, c = this.input.charCodeAt(this.state.pos)), (c === 69 || c === 101) && !h && (c = this.input.charCodeAt(++this.state.pos), (c === 43 || c === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(p.InvalidOrMissingExponent, { at: s }), i = true, o = true, c = this.input.charCodeAt(this.state.pos)), c === 110 && ((i || l) && this.raise(p.InvalidBigIntLiteral, { at: s }), ++this.state.pos, r = true), c === 109 && (this.expectPlugin("decimal", this.state.curPosition()), (o || l) && this.raise(p.InvalidDecimal, { at: s }), ++this.state.pos, n = true), $(this.codePointAtPos(this.state.pos)))
              throw this.raise(p.NumberIdentifier, { at: this.state.curPosition() });
          ...
          readCodePoint(t) {
            let { code: e, pos: s } = qs(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, this.errorHandlers_readCodePoint);
            return this.state.pos = s, e;
          }
          readString(t) {
            let { str: e, pos: s, curLine: i, lineStart: r } = Ps(t === 34 ? "double" : "single", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_string);
          ...
          readTemplateToken() {
            let t = this.input[this.state.pos], { str: e, firstInvalidLoc: s, pos: i, curLine: r, lineStart: n } = Ps("template", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_template);
            this.state.pos = i + 1, this.state.lineStart = n, this.state.curLine = r, s && (this.state.firstInvalidTemplateEscapePos = new B(s.curLine, s.pos - s.lineStart, s.pos)), this.input.codePointAt(i) === 96 ? this.finishToken(24, s ? null : t + e + "`") : (this.state.pos++, this.finishToken(25, s ? null : t + e + "${"));
          }
          ...
          readWord1(t) {
            ...
            for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length; ) {
              ...
              if (he(r))
                ...
                let n = this.state.curPosition(), o = this.state.pos === s ? $ : he;
          ...
          readWord(t) {
            let e = this.readWord1(t), s = Vt.get(e);
            s !== void 0 ? this.finishToken(s, J(s)) : this.finishToken(130, e);
          }
          checkKeywordEscapes() {
            let { type: t } = this.state;
            Jt(t) && this.state.containsEsc && this.raise(p.InvalidEscapedReservedWord, { at: this.state.startLoc, reservedWord: J(t) });
          }
          raise(t, e) {
            let { at: s } = e, i = He(e, jr), r = s instanceof B ? s : s.loc.start, n = t({ loc: r, details: i });
            if (!this.options.errorRecovery)
              throw n;
            return this.isLookahead || this.state.errors.push(n), n;
          }
          raiseOverwrite(t, e) {
            let { at: s } = e, i = He(e, $r), r = s instanceof B ? s : s.loc.start, n = r.index, o = this.state.errors;
          ...
          unexpected(t, e) {
            throw this.raise(p.UnexpectedToken, { expected: e ? J(e) : null, at: t ?? this.state.startLoc });
          }
          expectPlugin(t, e) {
            if (this.hasPlugin(t))
              return true;
          ...
          declarePrivateName(t, e, s) {
            ...
            if (e & ut) {
              let h = o && r.get(t);
              if (h) {
                let l = h & Ze, c = e & Ze, u = h & ut, f = e & ut;
        ...
        }, Kr = 0, Hs = 1, ts = 2, Ws = 3, fe = class {
          constructor(t = Kr) {
            this.type = void 0, this.type = t;
          }
          canBeArrowParameterDeclaration() {
            return this.type === ts || this.type === Hs;
          }
          ...
          constructor(t) {
            this.parser = void 0, this.stack = [new fe()], this.parser = t;
          }
          enter(t) {
            this.stack.push(t);
          }
          ...
          recordAsyncArrowParametersError({ at: t }) {
            ...
            for (; i.canBeArrowParameterDeclaration(); )
              i.type === ts && i.recordDeclarationError(p.AwaitBindingIdentifier, { at: t }), i = e[--s];
          }
          validateAsPattern() {
        ...
        var pe = 0, Xs = 1, it = 2, Gs = 4, re = 8, Ot = class {
          constructor() {
            this.stacks = [];
          }
          enter(t) {
        ...
        var Bt = class extends vt {
          ...
          hasPrecedingLineBreak() {
            return Ks.test(this.input.slice(this.state.lastTokEndLoc.index, this.state.start));
          }
          hasFollowingLineBreak() {
            return ys.lastIndex = this.state.end, ys.test(this.input);
          }
          isLineTerminator() {
          ...
          initializeScopes(t = this.options.sourceType === "module") {
            ...
            this.prodParam = new Ot();
            let h = this.classScope;
            this.classScope = new Dt(this);
            let l = this.expressionScope;
            return this.expressionScope = new Mt(this), () => {
          ...
          enterInitialScopes() {
            let t = pe;
            this.inModule && (t |= it), this.scope.enter(ne), this.prodParam.enter(t);
          }
          ...
          constructor(t, e, s) {
            this.type = "", this.start = e, this.end = 0, this.loc = new de(s), t != null && t.options.ranges && (this.range = [e, 0]), t != null && t.filename && (this.loc.filename = t.filename);
          }
        }, ss = me.prototype;
        ss.__clone = function() {
          let a = new me(void 0, this.start, this.loc.start), t = Object.keys(this);
        ...
        function z(a) {
          let { type: t, start: e, end: s, loc: i, range: r, extra: n, name: o } = a, h = Object.create(ss);
        ...
        var Yr = { const: "declare export var", let: "declare export var", type: "export type", interface: "export interface" };
        function Qr(a, t) {
          let e = [], s = [];
        ...
        var Zr = /\*?\s*@((?:no)?flow)\b/, ea = (a) => class extends a {
          constructor(...e) {
          ...
          flowParsePredicate() {
            ...
            return this.next(), this.expectContextual(108), this.state.lastTokStart > s.index + 1 && this.raise(T.UnexpectedSpaceBetweenModuloChecks, { at: s }), this.eat(10) ? (e.value = super.parseExpression(), this.expect(11), this.finishNode(e, "DeclaredPredicate")) : this.finishNode(e, "InferredPredicate");
          }
          ...
          flowParseDeclare(e, s) {
            ...
            if (this.eatContextual(125))
              return this.match(16) ? this.flowParseDeclareModuleExports(e) : (s && this.raise(T.NestedDeclareModule, { at: this.state.lastTokStartLoc }), this.flowParseDeclareModule(e));
          ...
          flowParseDeclareModule(e) {
            ...
            for (this.expect(5); !this.match(8); ) {
              ...
              this.match(83) ? (this.next(), !this.isContextual(128) && !this.match(87) && this.raise(T.InvalidNonTypeImportInDeclareModule, { at: this.state.lastTokStartLoc }), super.parseImport(o)) : (this.expectContextual(123, T.UnsupportedStatementInDeclareModule), o = this.flowParseDeclare(o, true)), i.push(o);
            }
            this.scope.exit(), this.expect(8), this.finishNode(s, "BlockStatement");
            let r = null, n = false;
            return i.forEach((o) => {
              Gr(o) ? (r === "CommonJS" && this.raise(T.AmbiguousDeclareModuleKind, { at: o }), r = "ES") : o.type === "DeclareModuleExports" && (n && this.raise(T.DuplicateDeclareModuleExports, { at: o }), r === "ES" && this.raise(T.AmbiguousDeclareModuleKind, { at: o }), r = "CommonJS", n = true);
          ...
          flowParseDeclareExportDeclaration(e, s) {
            ...
            if (this.match(75) || this.isLet() || (this.isContextual(128) || this.isContextual(127)) && !s) {
              ...
              throw this.raise(T.UnsupportedDeclareExportKind, { at: this.state.startLoc, unsupportedExportKind: i, suggestion: Yr[i] });
            }
          ...
          flowParseInterfaceish(e, s) {
            if (e.id = this.flowParseRestrictedIdentifier(!s, true), this.scope.declareName(e.id.name, s ? js : ce, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.extends = [], this.eat(81))
              do
          ...
          checkNotUnderscore(e) {
            e === "_" && this.raise(T.UnexpectedReservedUnderscore, { at: this.state.startLoc });
          }
          checkReservedType(e, s, i) {
            Xr.has(e) && this.raise(i ? T.AssignReservedType : T.UnexpectedReservedType, { at: s, reservedType: e });
          }
          ...
          flowParseTypeParameter(e = false) {
            ...
            return i.name = n.name, i.variance = r, i.bound = n.typeAnnotation, this.match(29) ? (this.eat(29), i.default = this.flowParseType()) : e && this.raise(T.MissingTypeParamDefault, { at: s }), this.finishNode(i, "TypeParameter");
          }
          ...
          flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
            ...
            for (s && this.match(6) ? (this.expect(6), l = 9, c = true) : (this.expect(5), l = 8, c = false), h.exact = c; !this.match(l); ) {
              ...
              if (this.eat(0))
                x != null && this.unexpected(x), this.eat(0) ? (w && this.unexpected(w.loc.start), h.internalSlots.push(this.flowParseObjectTypeInternalSlot(C, d))) : h.indexers.push(this.flowParseObjectTypeIndexer(C, d, w));
              else if (this.match(10) || this.match(47))
                x != null && this.unexpected(x), w && this.unexpected(w.loc.start), h.callProperties.push(this.flowParseObjectTypeCallProperty(C, d));
              else {
                let N = "init";
                if (this.isContextual(98) || this.isContextual(103)) {
                  let ge = this.lookahead();
                  Ns(ge.type) && (N = this.state.value, this.next());
                }
                let _e = this.flowParseObjectTypeProperty(C, d, x, w, N, i, n ?? !c);
                _e === null ? (u = true, I = this.state.lastTokStartLoc) : h.properties.push(_e);
              }
              this.flowObjectTypeSemicolon(), I && !this.match(8) && !this.match(9) && this.raise(T.UnexpectedExplicitInexactInObject, { at: I });
            }
          ...
          flowParseObjectTypeProperty(e, s, i, r, n, o, h) {
            if (this.eat(21))
              return this.match(12) || this.match(13) || this.match(8) || this.match(9) ? (o ? h || this.raise(T.InexactInsideExact, { at: this.state.lastTokStartLoc }) : this.raise(T.InexactInsideNonObject, { at: this.state.lastTokStartLoc }), r && this.raise(T.InexactVariance, { at: r }), null) : (o || this.raise(T.UnexpectedSpreadType, { at: this.state.lastTokStartLoc }), i != null && this.unexpected(i), r && this.raise(T.SpreadVariance, { at: r }), e.argument = this.flowParseType(), this.finishNode(e, "ObjectTypeSpreadProperty"));
            {
              e.key = this.flowParseObjectPropertyKey(), e.static = s, e.proto = i != null, e.kind = n;
              let l = false;
              return this.match(47) || this.match(10) ? (e.method = true, i != null && this.unexpected(i), r && this.unexpected(r.loc.start), e.value = this.flowParseObjectTypeMethodish(this.startNodeAt(e.loc.start)), (n === "get" || n === "set") && this.flowCheckGetterSetterParams(e), !o && e.key.name === "constructor" && e.value.this && this.raise(T.ThisParamBannedInConstructor, { at: e.value.this })) : (n !== "init" && this.unexpected(), e.method = false, this.eat(17) && (l = true), e.value = this.flowParseTypeInitialiser(), e.variance = r), e.optional = l, this.finishNode(e, "ObjectTypeProperty");
            }
          }
          flowCheckGetterSetterParams(e) {
            let s = e.kind === "get" ? 0 : 1, i = e.value.params.length + (e.value.rest ? 1 : 0);
            e.value.this && this.raise(e.kind === "get" ? T.GetterMayNotHaveThisParam : T.SetterMayNotHaveThisParam, { at: e.value.this }), i !== s && this.raise(e.kind === "get" ? p.BadGetterArity : p.BadSetterArity, { at: e }), e.kind === "set" && e.value.rest && this.raise(p.BadSetterRestParameter, { at: e });
          }
          ...
          flowParseFunctionTypeParam(e) {
            ...
            return o.type === 14 || o.type === 17 ? (h && !e && this.raise(T.ThisParamMustBeFirst, { at: n }), s = this.parseIdentifier(h), this.eat(17) && (i = true, h && this.raise(T.ThisParamMayNotBeOptional, { at: n })), r = this.flowParseTypeInitialiser()) : r = this.flowParseType(), n.name = s, n.optional = i, n.typeAnnotation = r, this.finishNode(n, "FunctionTypeParam");
          }
            ...
            switch (this.state.type) {
              ...
              case 53:
                if (this.state.value === "-") {
                  ...
                  throw this.raise(T.UnexpectedSubtractionOperand, { at: this.state.startLoc });
                }
                this.unexpected();
                return;
              case 132:
          ...
          shouldParseExportDeclaration() {
            ...
            return ds(e) || this.shouldParseEnums() && e === 124 ? !this.state.containsEsc : super.shouldParseExportDeclaration();
          }
          isExportDefaultSpecifier() {
            let { type: e } = this.state;
            return ds(e) || this.shouldParseEnums() && e === 124 ? this.state.containsEsc : super.isExportDefaultSpecifier();
          }
          ...
          parseConditional(e, s, i) {
            ...
            if (l || u.length > 0) {
              ...
              l && c.length > 1 && this.raise(T.AmbiguousConditionalArrow, { at: r.startLoc }), l && c.length === 1 && (this.state = r, f.push(c[0].start), this.state.noArrowAt = f, { consequent: h, failed: l } = this.tryParseConditionalConsequent());
            }
          ...
          getArrowLikeExpressions(e, s) {
            ...
            return s ? (r.forEach((n) => this.finishArrowValidation(n)), [r, []]) : Qr(r, (n) => n.params.every((o) => this.isAssignable(o, true)));
          }
          finishArrowValidation(e) {
            var s;
            this.toAssignableList(e.params, (s = e.extra) == null ? void 0 : s.trailingCommaLoc, false), this.scope.enter(K | Yt), super.checkParams(e, false, true), this.scope.exit();
          }
          ...
          parseClassMember(e, s, i) {
            ...
            super.parseClassMember(e, s, i), s.declare && (s.type !== "ClassProperty" && s.type !== "ClassPrivateProperty" && s.type !== "PropertyDefinition" ? this.raise(T.DeclareClassElement, { at: r }) : s.value && this.raise(T.DeclareClassFieldInitializer, { at: s.value }));
          }
          isIterator(e) {
          ...
          getTokenFromCode(e) {
            ...
            e === 123 && s === 124 ? this.finishOp(6, 2) : this.state.inType && (e === 62 || e === 60) ? this.finishOp(e === 62 ? 48 : 47, 1) : this.state.inType && e === 63 ? s === 46 ? this.finishOp(18, 2) : this.finishOp(17, 1) : br(e, s, this.input.charCodeAt(this.state.pos + 2)) ? (this.state.pos += 2, this.readIterator()) : super.getTokenFromCode(e);
          }
          isAssignable(e, s) {
          ...
          toReferencedList(e, s) {
            for (let r = 0; r < e.length; r++) {
              var i;
              let n = e[r];
              n && n.type === "TypeCastExpression" && !((i = n.extra) != null && i.parenthesized) && (e.length > 1 || !s) && this.raise(T.TypeCastInPattern, { at: n.typeAnnotation });
            }
            return e;
          }
          ...
          pushClassMethod(e, s, i, r, n, o) {
            if (s.variance && this.unexpected(s.variance.loc.start), delete s.variance, this.match(47) && (s.typeParameters = this.flowParseTypeParameterDeclaration()), super.pushClassMethod(e, s, i, r, n, o), s.params && n) {
              let h = s.params;
              h.length > 0 && this.isThisParam(h[0]) && this.raise(T.ThisParamBannedInConstructor, { at: s });
          ...
          checkGetterSetterParams(e) {
            ...
            if (s.length > 0) {
              let i = s[0];
              this.isThisParam(i) && e.kind === "get" ? this.raise(T.GetterMayNotHaveThisParam, { at: i }) : this.isThisParam(i) && this.raise(T.SetterMayNotHaveThisParam, { at: i });
            }
          }
          ...
          parseAssignableListItemTypes(e) {
            return this.eat(17) && (e.type !== "Identifier" && this.raise(T.PatternIsOptional, { at: e }), this.isThisParam(e) && this.raise(T.ThisParamMayNotBeOptional, { at: e }), e.optional = true), this.match(14) ? e.typeAnnotation = this.flowParseTypeAnnotation() : this.isThisParam(e) && this.raise(T.ThisParamAnnotationRequired, { at: e }), this.match(29) && this.isThisParam(e) && this.raise(T.ThisParamNoDefault, { at: e }), this.resetEndLocation(e), e;
          }
          parseMaybeDefault(e, s) {
            let i = super.parseMaybeDefault(e, s);
            return i.type === "AssignmentPattern" && i.typeAnnotation && i.right.start < i.typeAnnotation.start && this.raise(T.TypeBeforeInitializer, { at: i.typeAnnotation }), i;
          }
          checkImportReflection(e) {
            super.checkImportReflection(e), e.module && e.importKind !== "value" && this.raise(T.ImportReflectionHasImportType, { at: e.specifiers[0].loc.start });
          }
          parseImportSpecifierLocal(e, s, i) {
            s.local = Ts(e) ? this.flowParseRestrictedIdentifier(true, true) : this.parseIdentifier(), e.specifiers.push(this.finishImportSpecifier(s, i));
          }
          ...
          parseImportSpecifier(e, s, i, r, n) {
            ...
            if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
              ...
              h !== null && !M(this.state.type) ? (e.imported = u, e.importKind = h, e.local = z(u)) : (e.imported = o, e.importKind = null, e.local = this.parseIdentifier());
            } else {
              ...
              this.eatContextual(93) ? e.local = this.parseIdentifier() : (l = true, e.local = z(e.imported));
            }
            let c = Ts(e);
            return i && c && this.raise(T.ImportTypeShorthandOnlyInPureImport, { at: e }), (i || c) && this.checkReservedType(e.local.name, e.local.loc.start, true), l && !i && !c && this.checkReservedWord(e.local.name, e.loc.start, true, true), this.finishImportSpecifier(e, "ImportSpecifier");
          }
          parseBindingAtom() {
            switch (this.state.type) {
              case 78:
            ...
            if ((i = n) != null && i.error || this.match(47)) {
              ...
              if (c.node && this.maybeUnwrapTypeCastExpression(c.node).type === "ArrowFunctionExpression") {
                if (!c.error && !c.aborted)
                  return c.node.async && this.raise(T.UnexpectedTypeParameterBeforeAsyncArrowFunction, { at: l }), c.node;
                u = c.node;
              }
              if ((o = n) != null && o.node)
              ...
              throw (h = n) != null && h.thrown ? n.error : c.thrown ? c.error : this.raise(T.UnexpectedTokenAfterTypeParameter, { at: l });
            }
          ...
          checkParams(e, s, i, r = true) {
            if (!(i && this.state.noArrowParamsConversionAt.indexOf(e.start) !== -1)) {
              for (let n = 0; n < e.params.length; n++)
                this.isThisParam(e.params[n]) && n > 0 && this.raise(T.ThisParamMustBeFirst, { at: e.params[n] });
          ...
          parseTopLevel(e, s) {
            ...
            return this.state.hasFlowComment && this.raise(T.UnterminatedFlowComment, { at: this.state.curPosition() }), i;
          }
          skipBlockComment() {
            if (this.hasPlugin("flowComments") && this.skipFlowComment()) {
              if (this.state.hasFlowComment)
                throw this.raise(T.NestedFlowComment, { at: this.state.startLoc });
          ...
          flowEnumErrorBooleanMemberNotInitialized(e, { enumName: s, memberName: i }) {
            this.raise(T.EnumBooleanMemberNotInitialized, { at: e, memberName: i, enumName: s });
          }
          flowEnumErrorInvalidMemberInitializer(e, s) {
            return this.raise(s.explicitType ? s.explicitType === "symbol" ? T.EnumInvalidMemberInitializerSymbolType : T.EnumInvalidMemberInitializerPrimaryType : T.EnumInvalidMemberInitializerUnknownType, Object.assign({ at: e }, s));
          }
          flowEnumErrorNumberMemberNotInitialized(e, { enumName: s, memberName: i }) {
            this.raise(T.EnumNumberMemberNotInitialized, { at: e, enumName: s, memberName: i });
          }
          flowEnumErrorStringMemberInconsistentlyInitailized(e, { enumName: s }) {
            this.raise(T.EnumStringMemberInconsistentlyInitailized, { at: e, enumName: s });
          }
          flowEnumMemberInit() {
          ...
          flowEnumMembers({ enumName: e, explicitType: s }) {
            ...
            for (; !this.match(8); ) {
              ...
              if (c === "")
                continue;
              /^[a-z]/.test(c) && this.raise(T.EnumInvalidMemberName, { at: h, memberName: c, suggestion: c[0].toUpperCase() + c.slice(1), enumName: e }), i.has(c) && this.raise(T.EnumDuplicateMemberName, { at: h, memberName: c, enumName: e }), i.add(c);
          ...
          flowEnumParseExplicitType({ enumName: e }) {
            ...
            if (!S(this.state.type))
              throw this.raise(T.EnumInvalidExplicitTypeUnknownSupplied, { at: this.state.startLoc, enumName: e });
            let { value: s } = this.state;
            return this.next(), s !== "boolean" && s !== "number" && s !== "string" && s !== "symbol" && this.raise(T.EnumInvalidExplicitType, { at: this.state.startLoc, enumName: e, invalidEnumType: s }), s;
          }
          flowEnumBody(e, s) {
            ...
            switch (e.hasUnknownMembers = h, n) {
              ...
              default: {
                ...
                if (!u && !f && c >= d) {
                  ...
                  return this.raise(T.EnumInconsistentMemberValues, { at: r, enumName: i }), l();
              }
            }
          }
        ...
        var ta = (a) => class extends a {
          jsxReadToken() {
            let e = "", s = this.state.pos;
            for (; ; ) {
              if (this.state.pos >= this.length)
                throw this.raise(G.UnterminatedJsxContent, { at: this.state.startLoc });
              ...
              switch (i) {
                ...
                case 125:
                default:
                  Ne(i) ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadNewLine(true), s = this.state.pos) : ++this.state.pos;
              }
            }
          }
          jsxReadNewLine(e) {
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
          ...
          jsxReadString(e) {
            ...
            for (; ; ) {
              ...
              if (r === e)
                break;
              r === 38 ? (s += this.input.slice(i, this.state.pos), s += this.jsxReadEntity(), i = this.state.pos) : Ne(r) ? (s += this.input.slice(i, this.state.pos), s += this.jsxReadNewLine(false), i = this.state.pos) : ++this.state.pos;
            }
          ...
          jsxParseIdentifier() {
            let e = this.startNode();
            return this.match(138) ? e.name = this.state.value : Jt(this.state.type) ? e.name = J(this.state.type) : this.unexpected(), this.next(), this.finishNode(e, "JSXIdentifier");
          }
          ...
          jsxParseAttributeValue() {
            ...
            switch (this.state.type) {
              case 5:
                return e = this.startNode(), this.setContext(E.brace), this.next(), e = this.jsxParseExpressionContainer(e, E.j_oTag), e.expression.type === "JSXEmptyExpression" && this.raise(G.AttributeIsEmpty, { at: e }), e;
              case 140:
              case 131:
                return this.parseExprAtom();
              default:
                throw this.raise(G.UnsupportedJsxValue, { at: this.state.startLoc });
            }
          }
          ...
          jsxParseElementAt(e) {
            ...
            if (!r.selfClosing) {
              ...
              H(r) && !H(n) && n !== null ? this.raise(G.MissingClosingTagFragment, { at: n }) : !H(r) && H(n) ? this.raise(G.MissingClosingTagElement, { at: n, openingTagName: oe(r.name) }) : !H(r) && !H(n) && oe(n.name) !== oe(r.name) && this.raise(G.MissingClosingTagElement, { at: n, openingTagName: oe(r.name) });
            }
            if (H(r) ? (s.openingFragment = r, s.closingFragment = n) : (s.openingElement = r, s.closingElement = n), s.children = i, this.match(47))
              throw this.raise(G.UnwrappedAdjacentJSXElements, { at: this.state.startLoc });
            return H(r) ? this.finishNode(s, "JSXFragment") : this.finishNode(s, "JSXElement");
          }
          jsxParseElement() {
          ...
          updateContext(e) {
            ...
            if (i === 56 && e === 140)
              ...
              this.state.canStartJSXElement = ar(i);
          }
        }, _t = class extends ke {
          constructor(...t) {
          ...
          createScope(t) {
            return this.importsStack.push(/* @__PURE__ */ new Set()), new _t(t);
          }
          enter(t) {
            t == le && this.importsStack.push(/* @__PURE__ */ new Set()), super.enter(t);
          }
          exit() {
            let t = super.exit();
          ...
          declareName(t, e, s) {
            ...
            super.declareName(t, e, s), e & te && (e & F || (this.checkRedeclarationInScope(i, t, e, s), this.maybeExportDefined(i, t)), i.types.add(t)), e & bt && i.enums.add(t), e & At && i.constEnums.add(t), e & Ye && i.classes.add(t);
          }
          isRedeclaredInScope(t, e, s) {
            if (t.enums.has(e)) {
              if (s & bt) {
                let i = !!(s & At), r = t.constEnums.has(e);
                return i !== r;
              }
              return true;
            }
            return s & Ye && t.classes.has(e) ? t.lexical.has(e) ? !!(s & F) : false : s & te && t.types.has(e) ? true : super.isRedeclaredInScope(t, e, s);
          }
          checkLocalExport(t) {
            let { name: e } = t;
            if (this.hasImport(e))
        ...
        }, sa = (a, t) => Object.hasOwnProperty.call(a, t) && a[t], Ys = (a) => a.type === "ParenthesizedExpression" ? Ys(a.expression) : a, Ut = class extends Ft {
          ...
          isValidLVal(t, e, s) {
            return sa({ AssignmentPattern: "left", RestElement: "argument", ObjectProperty: "value", ParenthesizedExpression: "expression", ArrayPattern: "elements", ObjectPattern: "properties" }, t);
          }
          checkLVal(t, { in: e, binding: s = W, checkClashes: i = false, strictModeChanged: r = false, hasParenthesizedAncestor: n = false }) {
            var o;
            let h = t.type;
            ...
            if (l === true)
              return;
            if (l === false) {
              let d = s === W ? p.InvalidLhs : p.InvalidLhsBinding;
          ...
          checkIdentifier(t, e, s = false) {
            this.state.strict && (s ? Os(t.name, this.inModule) : Ms(t.name)) && (e === W ? this.raise(p.StrictEvalArguments, { at: t, referenceName: t.name }) : this.raise(p.StrictEvalArgumentsBinding, { at: t, bindingName: t.name })), e & st && t.name === "let" && this.raise(p.LetInLexicalBinding, { at: t }), e & W || this.declareNameFromIdentifier(t, e);
          }
        ...
        var oa = (a) => class extends a {
          ...
          tsParseModifiers({ allowedModifiers: e, disallowedModifiers: s, stopOnStartOfClassStaticBlock: i, errorTemplate: r = y.InvalidModifierOnTypeMember }, n) {
            ...
            for (; ; ) {
              ...
              if (!c)
                break;
              bs(c) ? n.accessibility ? this.raise(y.DuplicateAccessibilityModifier, { at: l, modifier: c }) : (o(l, c, c, "override"), o(l, c, c, "static"), o(l, c, c, "readonly"), n.accessibility = c) : na(c) ? (n[c] && this.raise(y.DuplicateModifier, { at: l, modifier: c }), n[c] = true, o(l, c, "in", "out")) : (Object.hasOwnProperty.call(n, c) ? this.raise(y.DuplicateModifier, { at: l, modifier: c }) : (o(l, c, "static", "readonly"), o(l, c, "static", "override"), o(l, c, "override", "readonly"), o(l, c, "abstract", "override"), h(l, c, "declare", "override"), h(l, c, "static", "abstract")), n[c] = true), s != null && s.includes(c) && this.raise(r, { at: l, modifier: c });
            }
          }
          ...
          tsParseDelimitedList(e, s, i) {
            return ra(this.tsParseDelimitedListWorker(e, s, true, i));
          }
          ...
          tsParseTupleType() {
            ...
            return e.elementTypes.forEach((r) => {
              ...
              (n = i) != null || (i = l), i !== l && this.raise(y.MixedLabeledAndUnlabeledElements, { at: r });
          ...
          tsParseNonArrayType() {
            switch (this.state.type) {
              ...
              default: {
                let { type: e } = this.state;
                if (S(e) || e === 88 || e === 84) {
                  let s = e === 88 ? "TSVoidKeyword" : e === 84 ? "TSNullKeyword" : aa(this.state.value);
          ...
          tsParseTypeOperatorOrHigher() {
            return pr(this.state.type) && !this.state.containsEsc ? this.tsParseTypeOperator() : this.isContextual(113) ? this.tsParseInferType() : this.tsInAllowConditionalTypesContext(() => this.tsParseArrayTypeOrHigher());
          }
          ...
          tsParseInterfaceDeclaration(e, s = {}) {
            if (this.hasFollowingLineBreak())
              return null;
            this.expectContextual(127), s.declare && (e.declare = true), S(this.state.type) ? (e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Cr)) : (e.id = null, this.raise(y.MissingInterfaceName, { at: this.state.startLoc })), e.typeParameters = this.tsTryParseTypeParameters(this.tsParseInOutConstModifiers), this.eat(81) && (e.extends = this.tsParseHeritageClause("extends"));
            let i = this.startNode();
          ...
          tsParseTypeAliasDeclaration(e) {
            return e.id = this.parseIdentifier(), this.checkIdentifier(e.id, wr), e.typeAnnotation = this.tsInType(() => {
          ...
          tsParseEnumDeclaration(e, s = {}) {
            return s.const && (e.const = true), s.declare && (e.declare = true), this.expectContextual(124), e.id = this.parseIdentifier(), this.checkIdentifier(e.id, e.const ? Nr : $s), this.expect(5), e.members = this.tsParseDelimitedList("EnumMembers", this.tsParseEnumMember.bind(this)), this.expect(8), this.finishNode(e, "TSEnumDeclaration");
          }
          tsParseModuleBlock() {
            let e = this.startNode();
          ...
          tsParseModuleOrNamespaceDeclaration(e, s = false) {
            if (e.id = this.parseIdentifier(), s || this.checkIdentifier(e.id, kr), this.eat(16)) {
              let i = this.startNode();
              this.tsParseModuleOrNamespaceDeclaration(i, true), e.body = i;
            } else
              this.scope.enter(le), this.prodParam.enter(pe), e.body = this.tsParseModuleBlock(), this.prodParam.exit(), this.scope.exit();
          ...
          tsParseImportEqualsDeclaration(e, s, i) {
            e.isExport = i || false, e.id = s || this.parseIdentifier(), this.checkIdentifier(e.id, Ie), this.expect(29);
          ...
          tsParseTypeArguments() {
            let e = this.startNode();
            return e.params = this.tsInType(() => this.tsInNoContext(() => (this.expect(47), this.tsParseDelimitedList("TypeParametersOrArguments", this.tsParseType.bind(this))))), e.params.length === 0 ? this.raise(y.EmptyTypeArguments, { at: e }) : !this.state.inType && this.curContext() === E.brace && this.reScan_lt_gt(), this.expect(48), this.finishNode(e, "TSTypeParameterInstantiation");
          }
          ...
          registerFunctionStatementId(e) {
            !e.body && e.id ? this.checkIdentifier(e.id, fs) : super.registerFunctionStatementId(e);
          }
          ...
          parseSubscript(e, s, i, r) {
            ...
            if (this.match(47) || this.match(51)) {
              let o, h = this.tsTryParseAndCatch(() => {
                ...
                if (c === 48 || c === 52 || c !== 10 && Tt(c) && !this.hasPrecedingLineBreak())
                  return;
          ...
          parseExprOp(e, s, i) {
            let r;
            if (Ve(58) > i && !this.hasPrecedingLineBreak() && (this.isContextual(93) || (r = this.isContextual(118)))) {
              let n = this.startNodeAt(s);
          ...
          parseVarStatement(e, s, i = false) {
            ...
            for (let { id: o, init: h } of n.declarations)
              h && (s !== "const" || o.typeAnnotation ? this.raise(y.InitializerNotAllowedInAmbientContext, { at: h }) : la(h, this.hasPlugin("estree")) || this.raise(y.ConstInitiailizerMustBeStringOrNumericLiteralOrLiteralEnumReference, { at: h }));
            return n;
          }
          ...
          tsHasSomeModifiers(e, s) {
            return s.some((i) => bs(i) ? e.accessibility === i : !!e[i]);
          }
          ...
          parseClassId(e, s, i, r) {
            if ((!s || i) && this.isContextual(111))
              return;
            super.parseClassId(e, s, i, e.declare ? fs : Us);
          ...
          parseMaybeAssign(e, s) {
            ...
            let f, d = this.tryParse((x) => {
              ...
              return (w.type !== "ArrowFunctionExpression" || (I = w.extra) != null && I.parenthesized) && x(), ((C = f) == null ? void 0 : C.params.length) !== 0 && this.resetStartLocationFromNode(w, f), w.typeParameters = f, w;
            }, l);
            if (!d.error && !d.aborted)
              return f && this.reportReservedArrowTypeParam(f), d.node;
            if (!c && (gs(!this.hasPlugin("jsx")), u = this.tryParse(() => super.parseMaybeAssign(e, s), l), !u.error))
              return u.node;
            if ((r = c) != null && r.node)
          ...
          isValidLVal(e, s, i) {
            return ia({ TSTypeCastExpression: true, TSParameterProperty: "parameter", TSNonNullExpression: "expression", TSAsExpression: (i !== W || !s) && ["expression", true], TSSatisfiesExpression: (i !== W || !s) && ["expression", true], TSTypeAssertion: (i !== W || !s) && ["expression", true] }, e) || super.isValidLVal(e, s, i);
          }
          parseBindingAtom() {
          ...
          parseImportSpecifier(e, s, i, r, n) {
            return !s && r ? (this.parseTypeOnlyImportExportSpecifier(e, true, i), this.finishNode(e, "ImportSpecifier")) : (e.importKind = "value", super.parseImportSpecifier(e, s, i, r, i ? ms : Ie));
          }
          parseTypeOnlyImportExportSpecifier(e, s, i) {
            ...
            e[f] = l ? "type" : "value", c && this.eatContextual(93) && (e[n] = s ? this.parseIdentifier() : this.parseModuleExportName()), e[n] || (e[n] = z(e[r])), s && this.checkIdentifier(e[n], l ? ms : Ie);
          }
        };
        function ha(a) {
          ...
          return t && e.type !== "StringLiteral" && (e.type !== "TemplateLiteral" || e.expressions.length > 0) ? false : Zs(a.object);
        }
        function la(a, t) {
          var e;
          let { type: s } = a;
          ...
          if (t) {
            ...
            return true;
          return !!(Qs(a, t) || ca(a, t) || s === "TemplateLiteral" && a.expressions.length === 0 || ha(a));
        }
        function Qs(a, t) {
        ...
        function Zs(a) {
          return a.type === "Identifier" ? true : a.type !== "MemberExpression" || a.computed ? false : Zs(a.object);
        }
        var As = V`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), pa = (a) => class extends a {
          parsePlaceholder(e) {
            if (this.match(142)) {
              let s = this.startNode();
          ...
          parseClass(e, s, i) {
            ...
            if (o)
              if (this.match(81) || this.match(142) || this.match(5))
                ...
                throw this.raise(As.ClassNameIsRequired, { at: this.state.startLoc });
              }
            else
          ...
          isExportDefaultSpecifier() {
            if (this.match(65)) {
              let e = this.nextTokenStart();
              if (this.isUnparsedContextual(e, "from") && this.input.startsWith(J(142), this.nextTokenStartSince(e + 4)))
                return true;
            }
          ...
          assertNoSpace() {
            this.state.start > this.state.lastTokEndLoc.index && this.raise(As.UnexpectedSpace, { at: this.state.lastTokEndLoc });
          }
        }, ua = (a) => class extends a {
          parseV8Intrinsic() {
            if (this.match(54)) {
        ...
        var Ss = ["minimal", "fsharp", "hack", "smart"], Es = ["^^", "@@", "^", "%", "#"], Cs = ["hash", "bar"];
        function da(a) {
          if (k(a, "decorators")) {
            if (k(a, "decorators-legacy"))
              throw new Error("Cannot use the decorators and decorators-legacy plugin together");
            let t = Y(a, "decorators", "decoratorsBeforeExport");
            if (t != null && typeof t != "boolean")
              throw new Error("'decoratorsBeforeExport' must be a boolean, if specified.");
            let e = Y(a, "decorators", "allowCallParenthesized");
          ...
          if (k(a, "pipelineOperator")) {
            let t = Y(a, "pipelineOperator", "proposal");
            if (!Ss.includes(t)) {
              let s = Ss.map((i) => `"${i}"`).join(", ");
            ...
            if (t === "hack") {
              ...
              let s = Y(a, "pipelineOperator", "topicToken");
              if (!Es.includes(s)) {
                let i = Es.map((r) => `"${r}"`).join(", ");
          ...
          if (k(a, "moduleAttributes")) {
            ...
            if (Y(a, "moduleAttributes", "version") !== "may-2020")
              throw new Error("The 'moduleAttributes' plugin requires a 'version' option, representing the last proposal update. Currently, the only supported value is 'may-2020'.");
          }
          if (k(a, "importAssertions") && k(a, "importAttributes"))
            throw new Error("Cannot combine importAssertions and importAttributes plugins.");
          if (k(a, "recordAndTuple") && Y(a, "recordAndTuple", "syntaxType") != null && !Cs.includes(Y(a, "recordAndTuple", "syntaxType")))
            throw new Error("The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " + Cs.map((t) => `'${t}'`).join(", "));
        ...
        var jt = class extends Ut {
          ...
          parseMaybeAssign(t, e) {
            ...
            if (e && (n = e.call(this, n, s)), nr(this.state.type)) {
          ...
          parseExprOp(t, e, s) {
            if (this.isPrivateName(t)) {
              ...
              (s >= Ve(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(p.PrivateInExpectedIn, { at: t, identifierName: r }), this.classScope.usePrivateName(r, t.loc.start);
            }
            let i = this.state.type;
            if (hr(i) && (this.prodParam.hasIn || !this.match(58))) {
              let r = Ve(i);
              if (r > s) {
                if (i === 39) {
                ...
                if (h && (r = Ve(42)), this.next(), i === 39 && this.hasPlugin(["pipelineOperator", { proposal: "minimal" }]) && this.state.type === 96 && this.prodParam.hasAwait)
          ...
          parseExprOpBaseRightExpr(t, e) {
            let s = this.state.startLoc;
            return this.parseExprOp(this.parseMaybeUnaryOrPrivate(), s, dr(t) ? e - 1 : e);
          }
          parseHackPipeBody() {
            var t;
            let { startLoc: e } = this.state, s = this.parseMaybeAssign();
            return Xi.has(s.type) && !((t = s.extra) != null && t.parenthesized) && this.raise(p.PipeUnparenthesizedBody, { at: e, type: s.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(p.PipeTopicUnused, { at: e }), s;
          }
          ...
          parseMaybeUnary(t, e) {
            ...
            if (i) {
              ...
              if ((this.hasPlugin("v8intrinsic") ? Tt(h) : Tt(h) && !this.match(54)) && !this.isAmbiguousAwait())
          ...
          parseUpdate(t, e, s) {
            ...
            if (this.checkExpressionErrors(s, false))
              return r;
            for (; lr(this.state.type) && !this.canInsertSemicolon(); ) {
          ...
          parseCoverCallAndAsyncArrowHead(t, e, s, i) {
            ...
            h && (this.expressionScope.enter(Hr()), n = new ue()), l && (o.optional = i), i ? o.arguments = this.parseCallExpressionArguments(11) : o.arguments = this.parseCallExpressionArguments(11, t.type === "Import", t.type !== "Super", o, n);
          ...
          parseAsyncArrowFromCallExpression(t, e) {
            var s;
            return this.resetPreviousNodeTrailingComments(e), this.expect(19), this.parseArrowExpression(t, e.arguments, true, (s = e.extra) == null ? void 0 : s.trailingCommaLoc), e.innerComments && Le(t, e.innerComments), e.callee.trailingComments && Le(t, e.callee.trailingComments), t;
          }
          parseNoCallExpr() {
          ...
          parseExprAtom(t) {
            ...
            switch (i) {
              ...
              case 47: {
                ...
                $(r) || r === 62 ? this.expectOnePlugin(["jsx", "flow", "typescript"]) : this.unexpected();
                break;
              }
              default:
                if (S(i)) {
          ...
          finishTopicReference(t, e, s, i) {
            if (this.testTopicReferenceConfiguration(s, e, i)) {
              ...
              throw this.raise(p.PipeTopicUnconfiguredToken, { at: e, token: J(i) });
          }
          ...
          parseDo(t, e) {
            ...
            return this.state.labels = [], e ? (this.prodParam.enter(it), t.body = this.parseBlock(), this.prodParam.exit()) : t.body = this.parseBlock(), this.state.labels = s, this.finishNode(t, "DoExpression");
          }
          parseSuper() {
            let t = this.startNode();
...
`), cooked: r === null ? null : r.slice(1, l) }, o.tail = h, this.next();
          ...
          parseObjectProperty(t, e, s, i) {
            ...
            if (!t.computed && t.key.type === "Identifier") {
              if (this.checkReservedWord(t.key.name, t.key.loc.start, true, false), s)
                t.value = this.parseMaybeDefault(e, z(t.key));
              else if (this.match(29)) {
                let r = this.state.startLoc;
                i != null ? i.shorthandAssignLoc === null && (i.shorthandAssignLoc = r) : this.raise(p.InvalidCoverInitializedName, { at: r }), t.value = this.parseMaybeDefault(e, z(t.key));
              } else
                t.value = z(t.key);
          ...
          parseMethod(t, e, s, i, r, n, o = false) {
            this.initFunction(t, s), t.generator = e, this.scope.enter(K | Xe | (o ? Z : 0) | (r ? Fs : 0)), this.prodParam.enter(qe(s, t.generator)), this.parseFunctionParams(t, i);
          ...
          parseFunctionBody(t, e, s = false) {
            ...
            if (this.expressionScope.enter(Js()), i)
              t.body = this.parseMaybeAssign(), this.checkParams(t, false, e, false);
            else {
              let r = this.state.strict, n = this.state.labels;
              this.state.labels = [], this.prodParam.enter(this.prodParam.currentFlags() | Gs), t.body = this.parseBlock(true, false, (o) => {
                ...
                this.checkParams(t, !this.state.strict && !e && !s && !h, e, l), this.state.strict && t.id && this.checkIdentifier(t.id, Ir, l);
          ...
          checkParams(t, e, s, i = true) {
            ...
            for (let o of t.params)
              this.checkLVal(o, { in: n, binding: Qe, checkClashes: r, strictModeChanged: i });
          }
          ...
          checkReservedWord(t, e, s, i) {
            ...
            if ((this.state.strict ? i ? Os : Ds : Ls)(t, this.inModule)) {
          ...
          isAmbiguousAwait() {
            if (this.hasPrecedingLineBreak())
              return true;
            let { type: t } = this.state;
            return t === 53 || t === 10 || t === 0 || Je(t) || t === 101 && !this.state.containsEsc || t === 135 || t === 56 || this.hasPlugin("v8intrinsic") && t === 54;
          }
          parseYield() {
            let t = this.startNode();
        ...
        }, mt = { kind: "loop" }, ya = { kind: "switch" }, xa = /[\uD800-\uDFFF]/u, yt = /in(?:stanceof)?/y;
        function Pa(a, t) {
            ...
            if (typeof i == "number") {
              {
                if (i === 136) {
                  ...
                  a.splice(e, 1, new O({ type: U(27), value: "#", start: n, end: l, startLoc: r.start, endLoc: c }), new O({ type: U(130), value: o, start: l, end: h, startLoc: c, endLoc: r.end })), e++;
                  continue;
                }
                if (Je(i)) {
                  let { loc: r, start: n, value: o, end: h } = s, l = n + 1, c = L(r.start, 1), u;
                  t.charCodeAt(n) === 96 ? u = new O({ type: U(22), value: "`", start: n, end: l, startLoc: r.start, endLoc: c }) : u = new O({ type: U(8), value: "}", start: n, end: l, startLoc: r.start, endLoc: c });
                  let f, d, x, I;
                  i === 24 ? (d = h - 1, x = L(r.end, -1), f = o === null ? null : o.slice(1, -1), I = new O({ type: U(22), value: "`", start: d, end: h, startLoc: x, endLoc: r.end })) : (d = h - 2, x = L(r.end, -2), f = o === null ? null : o.slice(1, -2), I = new O({ type: U(23), value: "${", start: d, end: h, startLoc: x, endLoc: r.end })), a.splice(e, 1, u, new O({ type: U(20), value: f, start: l, end: d, startLoc: c, endLoc: x }), I), e += 2;
                  continue;
                }
              }
              s.type = U(i);
        ...
        var $t = class extends jt {
          parseTopLevel(t, e) {
            return t.program = this.parseProgram(e), t.comments = this.state.comments, this.options.tokens && (t.tokens = Pa(this.tokens, this.input)), this.finishNode(t, "File");
          }
          ...
          chStartsBindingIdentifier(t, e) {
            if ($(t)) {
              if (yt.lastIndex = e, yt.test(this.input)) {
                let s = this.codePointAtPos(yt.lastIndex);
                if (!he(s) && s !== 92)
                  return false;
              }
              return true;
          ...
          parseDoWhileStatement(t) {
            return this.next(), this.state.labels.push(mt), t.body = this.withSmartMixTopicForbiddingContext(() => this.parseStatement()), this.state.labels.pop(), this.expect(92), t.test = this.parseHeaderExpression(), this.eat(13), this.finishNode(t, "DoWhileStatement");
          }
          parseForStatement(t) {
            this.next(), this.state.labels.push(mt);
            let e = null;
            if (this.isAwaitAllowed() && this.eatContextual(96) && (e = this.state.lastTokStartLoc), this.scope.enter(ae), this.expect(10), this.match(13))
            ...
            let i = this.isContextual(95), r = new ue(), n = this.parseExpression(true, r), o = this.isContextual(101);
          ...
          parseSwitchStatement(t) {
            ...
            let e = t.cases = [];
            this.expect(5), this.state.labels.push(ya), this.scope.enter(ae);
            let s;
          ...
          parseCatchClauseParam() {
            ...
            return this.scope.enter(this.options.annexB && t.type === "Identifier" ? Bs : 0), this.checkLVal(t, { in: { type: "CatchClause" }, binding: Er }), t;
          }
          parseTryStatement(t) {
          ...
          parseWhileStatement(t) {
            return this.next(), t.test = this.parseHeaderExpression(), this.state.labels.push(mt), t.body = this.withSmartMixTopicForbiddingContext(() => this.parseStatement()), this.state.labels.pop(), this.finishNode(t, "WhileStatement");
          }
          ...
          parseLabeledStatement(t, e, s, i) {
            ...
            let r = or(this.state.type) ? "loop" : this.match(71) ? "switch" : null;
          ...
          parseVarId(t, e) {
            ...
            this.checkLVal(s, { in: { type: "VariableDeclarator" }, binding: e === "var" ? Qe : ce }), t.id = s;
          }
          ...
          parseFunction(t, e = 0) {
            ...
            return this.state.maybeInArrowParameters = false, this.scope.enter(K), this.prodParam.enter(qe(n, t.generator)), i || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, false), this.withSmartMixTopicForbiddingContext(() => {
          ...
          parseFunctionParams(t, e) {
            this.expect(10), this.expressionScope.enter(zr()), t.params = this.parseBindingList(11, 41, 2 | (e ? 4 : 0)), this.expressionScope.exit();
          }
          registerFunctionStatementId(t) {
            t.id && this.scope.declareName(t.id.name, !this.options.annexB || this.state.strict || t.generator || t.async ? this.scope.treatFunctionsAsVar ? Qe : ce : js, t.id.loc.start);
          }
          parseClass(t, e, s) {
            this.next();
          ...
          parseClassMemberWithIsStatic(t, e, s, i) {
            ...
            if (this.parsePostMemberNameModifiers(u), this.isClassMethod()) {
              ...
              let C = this.isNonstaticConstructor(r), w = false;
              C && (r.kind = "constructor", s.hadConstructor && !this.hasPlugin("typescript") && this.raise(p.DuplicateConstructor, { at: x }), C && this.hasPlugin("typescript") && e.override && this.raise(p.OverrideOnConstructor, { at: x }), s.hadConstructor = true, w = s.hadSuperClass), this.pushClassMethod(t, r, false, false, C, w);
            } else if (this.isClassProperty())
              ...
              this.parseClassElementName(c), this.parsePostMemberNameModifiers(u), w ? this.pushClassPrivateMethod(t, n, C, true) : (this.isNonstaticConstructor(r) && this.raise(p.ConstructorIsAsync, { at: r.key }), this.pushClassMethod(t, r, C, true, false, false));
          ...
          pushClassPrivateProperty(t, e) {
            ...
            t.body.push(s), this.classScope.declarePrivateName(this.getPrivateNameSV(s.key), dt, s.key.loc.start);
          }
          ...
          pushClassPrivateMethod(t, e, s, i) {
            ...
            t.body.push(r);
            let n = r.kind === "get" ? r.static ? Lr : Mr : r.kind === "set" ? r.static ? Dr : Or : dt;
          ...
          parseInitializer(t) {
            this.scope.enter(Z | Xe), this.expressionScope.enter(Js()), this.prodParam.enter(pe), t.value = this.eat(29) ? this.parseMaybeAssignAllowIn() : null, this.expressionScope.exit(), this.prodParam.exit(), this.scope.exit();
          }
          parseClassId(t, e, s, i = Us) {
            if (S(this.state.type))
            ...
            if (e) {
              if (s) {
                if (this.checkDuplicateExports(t, "default"), this.hasPlugin("exportDefaultFrom")) {
                  var r;
                  let n = t.declaration;
                  n.type === "Identifier" && n.name === "from" && n.end - n.start === 4 && !((r = n.extra) != null && r.parenthesized) && this.raise(p.ExportDefaultFromAsIdentifier, { at: n });
                }
              } else if (t.specifiers && t.specifiers.length)
                for (let n of t.specifiers) {
                  let { exported: o } = n, h = o.type === "Identifier" ? o.name : o.value;
                  if (this.checkDuplicateExports(n, h), !i && n.local) {
                    let { local: l } = n;
                    l.type !== "Identifier" ? this.raise(p.ExportBindingIsString, { at: n, localName: l.value, exportName: h }) : (this.checkReservedWord(l.name, l.loc.start, true, false), this.scope.checkLocalExport(l));
                  }
                }
          ...
          parseExportSpecifier(t, e, s, i) {
            return this.eatContextual(93) ? t.exported = this.parseModuleExportName() : e ? t.exported = Jr(t.local) : t.exported || (t.exported = z(t.local)), this.finishNode(t, "ExportSpecifier");
          }
          parseModuleExportName() {
            if (this.match(131)) {
              let t = this.parseStringLiteral(this.state.value), e = t.value.match(xa);
          ...
          parseImportSpecifier(t, e, s, i, r) {
            if (this.eatContextual(93))
              ...
              this.checkReservedWord(n.name, t.loc.start, true, true), t.local || (t.local = z(n));
            }
          ...
          constructor(t, e) {
            t = ma(t), super(t, e), this.options = t, this.initializeScopes(), this.plugins = Ta(this.options.plugins), this.filename = t.sourceFilename;
          }
          getScopeHandler() {
            return ve;
          }
        ...
        function Ce(a, t) {
          let e = tt;
          return a != null && a.plugins && (da(a.plugins), e = Ea(a.plugins)), new e(a, t);
        }
        var Is = {};
        function Ea(a) {
          let t = fa.filter((i) => k(a, i)), e = t.join("/"), s = Is[e];
          if (!s) {
            s = tt;
            for (let i of t)
              s = ei[i](s);
      ...
      var fi = ls((se) => {
        ...
        function di(a) {
          let t = `
`;
          a = a.replace(Da, "").replace(La, "").replace(Ba, "$1");
          let e = "";
          for (; e !== a; )
            e = a, a = a.replace(Oa, `${t}$1 $2${t}`);
          a = a.replace(hi, "").trimRight();
          let s = /* @__PURE__ */ Object.create(null), i = a.replace(li, "").replace(hi, "").trimRight(), r;
          for (; r = li.exec(a); ) {
            let n = r[2].replace(Ma, "");
            typeof s[r[1]] == "string" || Array.isArray(s[r[1]]) ? s[r[1]] = ui.concat(s[r[1]], n) : s[r[1]] = n;
          }
          return { comments: i, pragmas: s };
        }
        function Ua({ comments: a = "", pragmas: t = {} }) {
          let e = `
`, s = "/**", i = " *", r = " */", n = Object.keys(t), o = n.map((l) => ci(l, t[l])).reduce((l, c) => l.concat(c), []).map((l) => `${i} ${l}${e}`).join("");
          if (!a) {
            if (n.length === 0)
              return "";
            if (n.length === 1 && !Array.isArray(t[n[0]])) {
              let l = t[n[0]];
              return `${s} ${ci(n[0], l)[0]}${r}`;
            }
          }
        ...
        function ci(a, t) {
          return ui.concat(t).map((e) => `@${a} ${e}`.trim());
        }
      });
      var dn = {};
      Vi(dn, { parsers: () => un });
...
` || i === "\r" || i === "\u2028" || i === "\u2029")
      ...
      var wn = at(/\s/), ri = at(" 	"), In = at(",; 	"), ai = at(/[^\n\r]/);
      function ka(a, t) {
        return t === false ? false : a.charAt(t) === "/" && a.charAt(t + 1) === "/" ? ai(a, t) : t;
      }
      var ni = ka;
      function va(a, t) {
        let e = null, s = t;
        for (; s !== e; )
          e = s, s = ri(a, s), s = si(a, s), s = ni(a, s), s = ii(a, s);
        return s;
      }
      var oi = va;
      var ye = ct(fi(), 1);
      function ja(a) {
        ...
        let e = (0, ye.extract)(a), { pragmas: s, comments: i } = (0, ye.parseWithComments)(e);
      ...
      function D(a) {
        ...
        return ie(e) ? Math.min(D(e[0]), t) : t;
      }
      function _(a) {
        return a.range ? a.range[1] : a.end;
      }
      function Va(a) {
        return a = typeof a == "function" ? { parse: a } : a, { astFormat: "estree", hasPragma: mi, locStart: D, locEnd: _, ...a };
      }
      var xe = Va;
      function Ka(a, t) {
      ...
      function za(a) {
        ...
        return nt(t.replace(/ \(.*\)$/, ""), { loc: { start: { line: e ? e.line : 0, column: e ? e.column + 1 : 0 } }, cause: a });
      }
      var Me = za;
      var qa = (a, t, e) => {
        if (!(a && t == null))
      ...
      var yi = Ha;
      var Wa = yi(["Block", "CommentBlock", "MultiLine"]), Oe = Wa;
      function Ja(a) {
        return Oe(a) && a.value[0] === "*" && /@(?:type|satisfies)\b/.test(a.value);
      }
      var xi = Ja;
      function Xa(a) {
        let t = `*${a.value}*`.split(`
`);
      ...
      function Fe(a) {
        if (Be !== null && typeof Be.property) {
          let t = Be;
          return Be = Fe.prototype = null, t;
        }
        return Be = Fe.prototype = a ?? /* @__PURE__ */ Object.create(null), new Fe();
      }
      var Ga = 10;
      for (let a = 0; a <= Ga; a++)
        Fe();
      ...
      function Za(a, t) {
        ...
        if (e === "babel") {
          ...
          a = ot(a, (n) => {
            var o;
            (o = n.leadingComments) != null && o.some(xi) && r.add(D(n));
          }), a = ot(a, (n) => {
        ...
        if (a = ot(a, (r) => {
          switch (r.type) {
            ...
            case "VariableDeclaration": {
              let n = rs(false, r.declarations, -1);
              n != null && n.init && i(r, n);
              break;
            }
          ...
          let r = rs(false, a.comments, -1);
          for (let n = a.comments.length - 2; n >= 0; n--) {
            let o = a.comments[n];
            _(o) === D(r) && Oe(o) && Oe(r) && as(o) && as(r) && (a.comments.splice(n + 1, 1), o.value += "*//*" + r.value, o.range = [D(o), _(r)]), r = o;
          }
        }
      ...
      function hs(a) {
        return bi(a) ? hs({ type: "LogicalExpression", operator: a.operator, left: hs({ type: "LogicalExpression", operator: a.operator, left: a.left, right: a.right.left, range: [D(a.left), _(a.right.left)] }), right: a.right.right, range: [D(a), _(a)] }) : a;
      }
      var Ai = Za;
      function en(a) {
        let { filepath: t } = a;
      ...
      function nn(a, t) {
        ...
        let s = oi(a, 0);
        return s !== false && (a = a.slice(0, s)), an.test(a);
      }
      function on(a, t, e) {
        let s = a(t, e), i = s.errors.find((r) => !ln.has(r.reasonCode));
        if (i)
          throw i;
        return s;
      }
      function hn({ isExpression: a = false, optionsCombinations: t }) {
        return (e, s = {}) => {
          if ((s.parser === "babel" || s.parser === "__babel_estree") && nn(e, s))
            return s.parser = "babel-flow", Li.parse(e, s);
          let i = t;
          (s.__babelSourceType ?? Si(s)) === "script" && (i = i.map((l) => ({ ...l, sourceType: "script" }))), /#[[{]/.test(e) && (i = i.map((l) => R([rn], l)));
          let n = /%[A-Z]/.test(e);
          e.includes("|>") ? i = (n ? [...Ci, Ei] : Ci).flatMap((c) => i.map((u) => R([c], u))) : n && (i = i.map((l) => R([Ei], l)));
          let o = a ? lt.parseExpression : lt.parse, h;
          try {
            h = ti(i.map((l) => () => on(o, e, l)));
          } catch ({ errors: [l] }) {
            throw Me(l);
          }
          return a && (h = ht(h, { text: e, rootMarker: s.rootMarker })), Ai(h, { parser: "babel", text: e });
        };
      }
      var ln = /* @__PURE__ */ new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "MixedLabeledAndUnlabeledElements", "DuplicateAccessibilityModifier", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "DeclareFunctionHasImplementation", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]), vi = [R(["jsx"])], wi = Pe({ optionsCombinations: vi }), Ii = Pe({ optionsCombinations: [R(["jsx", "typescript"]), R(["typescript"])] }), Ni = Pe({ isExpression: true, optionsCombinations: [R(["jsx"])] }), ki = Pe({ isExpression: true, optionsCombinations: [R(["typescript"])] }), Li = Pe({ optionsCombinations: [R(["jsx", ["flow", { all: true, enums: true }], "flowComments"])] }), cn = Pe({ optionsCombinations: vi.map((a) => R(["estree"], a)) }), Di = { babel: wi, "babel-flow": Li, "babel-ts": Ii, __js_expression: Ni, __ts_expression: ki, __vue_expression: Ni, __vue_ts_expression: ki, __vue_event_binding: wi, __vue_ts_event_binding: Ii, __babel_estree: cn };
      var Oi = ct(is(), 1);
      function Bi(a = {}) {
        ...
        return function(s) {
          let i;
          try {
            i = (0, Oi.parseExpression)(s, { tokens: true, ranges: true });
          } catch (r) {
            throw (r == null ? void 0 : r.reasonCode) === "MissingPlugin" || (r == null ? void 0 : r.reasonCode) === "MissingOneOfPlugins" ? Me({ message: "Unexpected token", loc: r.loc }) : Me(r);
          }
          if (!t && ie(i.comments))
            throw X(i.comments[0], "Comment");
          return Te(i), ht(i, { type: "JsonRoot", text: s });
        };
      }
      function X(a, t) {
        let [e, s] = [a.loc.start, a.loc.end].map(({ line: i, column: r }) => ({ line: i, column: r + 1 }));
        return nt(`${t} is not allowed in JSON.`, { loc: { start: e, end: s } });
      }
      function Te(a) {
        switch (a.type) {
          case "ArrayExpression":
          ...
          case "ObjectProperty":
            if (a.computed)
              throw X(a.key, "Computed key");
            if (a.shorthand)
              throw X(a.key, "Shorthand property");
            a.key.type !== "Identifier" && Te(a.key), Te(a.value);
            return;
          case "UnaryExpression": {
            let { operator: t, argument: e } = a;
            if (t !== "+" && t !== "-")
              throw X(a, `Operator '${a.operator}'`);
            if (e.type === "NumericLiteral" || e.type === "Identifier" && (e.name === "Infinity" || e.name === "NaN"))
              return;
            throw X(e, `Operator '${t}' before '${e.type}'`);
          }
          case "Identifier":
            if (a.name !== "Infinity" && a.name !== "NaN" && a.name !== "undefined")
              throw X(a, `Identifier '${a.name}'`);
            return;
          case "TemplateLiteral":
            if (ie(a.expressions))
              throw X(a.expressions[0], "'TemplateLiteral' with expression");
      ...
      var Mi = Bi(), pn = { json: xe({ parse: Mi, hasPragma() {
        return true;
      } }), json5: xe(Mi), "json-stringify": xe({ parse: Bi({ allowComments: false }), astFormat: "estree-json" }) }, Fi = pn;
      var un = { ...Di, ...Fi };
      return Ki(dn);
    });
  }
