...
import {
  ...
  rgba,
  withReset
} from "./chunk-4P45RB4W.js";
import {
  ActionBar
} from "./chunk-QNPAVEWS.js";
import {
  stringify
} from "./chunk-WYCDHGCD.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-TKG24PKR.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  str
} from "./chunk-O4JGBU2F.js";
import {
  v
} from "./chunk-BI6SF4IK.js";
import {
  require_core_events
} from "./chunk-H4QULZTR.js";
import {
  esm_default
} from "./chunk-6JVAWBCK.js";
import {
  _extends,
  ...
  rgba as rgba2
} from "./chunk-SMAFQPL4.js";
import {
  index_modern_default
} from "./chunk-5Y35J7SW.js";
import {
  require_uniq
} from "./chunk-XAQQJ4YK.js";
import {
  require_memoizerific
} from "./chunk-D2C6NKAO.js";
import {
  require_pickBy
} from "./chunk-IAGTAPA6.js";
import {
  require_mapValues
} from "./chunk-5GWTVP2C.js";
import {
  require_cloneDeep
} from "./chunk-TKT3VQGD.js";
import {
  require_react_dom
} from "./chunk-KCJI6Z4Z.js";
import {
  scope
} from "./chunk-53B3XB6V.js";
import {
  require_react
} from "./chunk-MBTNGYJ5.js";
import {
  require_channels
} from "./chunk-UC2KDV2D.js";
import {
  require_client_logger
} from "./chunk-VT3CHZJ5.js";
import {
  require_preview_api
...
var Fallback = ({ size: size2 }) => {
  return import_react25.default.createElement("div", { style: { width: size2, height: size2 } });
};
function withSuspense(WrappedComponent) {
  function ComponentWithSuspense(props) {
    return import_react25.default.createElement(import_react25.Suspense, { fallback: import_react25.default.createElement(Fallback, { ...props }) }, import_react25.default.createElement(WrappedComponent, { ...props }));
  }
...
var Photo = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Images-S2WTXNGG-QJXJTQVR.js");
...
var Book = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Documents-SGWAY3KW-L44TUKUH.js");
...
var Markup = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Editing-7QFB6ZMG-2SSBDGGJ.js");
...
var Repo = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Git-DZ2D5ZUL-ADKQQVXQ.js");
...
var Apple = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./OS-YZ2Y4VYS-LRBMFWX6.js");
...
var Storybook = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Logos-SJTNNI74-RO3QRATN.js");
...
var Browser = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Devices-SUYACUPO-2TSVF7VJ.js");
...
var Edit = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./CRUD-I5EZL2FS-JAIMGYL2.js");
...
var Info = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Communicate-7JXCND2Z-V5FCHKJC.js");
...
var ChevronUp = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Wayfinding-BB4H7CHP-HYZ6HNDX.js");
...
var User = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./People-OD4EV7WZ-YPM4ARKK.js");
...
// ../../node_modules/@storybook/components/dist/experimental.mjs
var Button2 = (0, import_react26.forwardRef)(({ as, children, icon, ...props }, ref) => import_react26.default.createElement(StyledButton, { as, ref, ...props }, icon, !props.iconOnly && children));
Button2.displayName = "Button";
var StyledButton = newStyled.button(({ theme, variant = "primary", size: size2 = "medium", disabled = false, active = false, iconOnly = false }) => ({ border: 0, cursor: disabled ? "not-allowed" : "pointer", display: "inline-flex", gap: "6px", alignItems: "center", justifyContent: "center", overflow: "hidden", padding: `${(() => !iconOnly && size2 === "small" ? "0 10px" : !iconOnly && size2 === "medium" ? "0 12px" : 0)()}`, width: `${(() => iconOnly && size2 === "small" ? "28px" : iconOnly && size2 === "medium" ? "32px" : "auto")()}`, height: size2 === "small" ? "28px" : "32px", position: "relative", textAlign: "center", textDecoration: "none", transitionProperty: "background, box-shadow", transitionDuration: "150ms", transitionTimingFunction: "ease-out", verticalAlign: "top", whiteSpace: "nowrap", userSelect: "none", opacity: disabled ? 0.5 : 1, margin: 0, fontSize: `${theme.typography.size.s1}px`, fontWeight: theme.typography.weight.bold, lineHeight: "1", background: `${(() => variant === "primary" ? theme.color.secondary : variant === "secondary" ? theme.button.background : variant === "tertiary" && active ? theme.background.hoverable : "transparent")()}`, color: `${(() => variant === "primary" ? theme.color.lightest : variant === "secondary" ? theme.input.color : variant === "tertiary" && active ? theme.color.secondary : variant === "tertiary" ? theme.color.mediumdark : theme.input.color)()}`, boxShadow: variant === "secondary" ? `${theme.button.border} 0 0 0 1px inset` : "none", borderRadius: theme.input.borderRadius, "&:hover": { color: variant === "tertiary" ? theme.color.secondary : null, background: `${(() => {
  let bgColor = theme.color.secondary;
  return variant === "primary" && (bgColor = theme.color.secondary), variant === "secondary" && (bgColor = theme.button.background), variant === "tertiary" ? curriedTransparentize$1(0.86, theme.color.secondary) : theme.base === "light" ? curriedDarken$1(0.02, bgColor) : curriedLighten$1(0.03, bgColor);
})()}` }, "&:active": { color: variant === "tertiary" ? theme.color.secondary : null, background: `${(() => {
  let bgColor = theme.color.secondary;
  return variant === "primary" && (bgColor = theme.color.secondary), variant === "secondary" && (bgColor = theme.button.background), variant === "tertiary" ? theme.background.hoverable : theme.base === "light" ? curriedDarken$1(0.02, bgColor) : curriedLighten$1(0.03, bgColor);
})()}` }, "&:focus": { boxShadow: `${rgba(theme.color.secondary, 1)} 0 0 0 1px inset`, outline: "none" } }));
var Input = (0, import_react26.forwardRef)(({ ...props }, ref) => import_react26.default.createElement(StyledInput, { ref, ...props }));
...
var IconWrapper = ({ icon, color: colorProp, size: sizeProp, ...restProps }) => {
...
var Link2 = (0, import_react26.forwardRef)(({ as, children, icon, withArrow, ...props }, ref) => import_react26.default.createElement(StyledLink, { as, ref, ...props }, import_react26.default.createElement(StyledLeft, null, icon, children), withArrow && import_react26.default.createElement(ChevronRight, { size: 8 })));
Link2.displayName = "Link";
var StyledLink = newStyled.a(({ theme, variant = "primary" }) => ({ display: "inline-flex", gap: 4, alignItems: "center", transition: "all 150ms ease-out", textDecoration: "none", lineHeight: 1, color: `${(() => variant === "primary" ? theme.color.secondary : variant === "secondary" ? theme.textMutedColor : variant === "tertiary" ? theme.color.dark : theme.color.secondary)()}`, "&:hover, &:focus": { cursor: "pointer", color: `${(() => variant === "primary" ? curriedDarken$1(0.07, theme.color.secondary) : variant === "secondary" ? theme.color.dark : variant === "tertiary" ? theme.color.darkest : curriedDarken$1(0.07, theme.color.secondary))()}` }, "&:active": { color: `${(() => variant === "primary" ? curriedDarken$1(0.1, theme.color.secondary) : variant === "secondary" ? theme.color.darker : variant === "tertiary" ? theme.textMutedColor : curriedDarken$1(0.1, theme.color.secondary))()}` } }));
...
var EmptyBlock = (props) => import_react27.default.createElement(Wrapper, { ...props, className: "docblock-emptyblock sb-unstyled" });
...
var SourceSkeleton = () => import_react27.default.createElement(SourceSkeletonWrapper, null, import_react27.default.createElement(SourceSkeletonPlaceholder, null), import_react27.default.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }), import_react27.default.createElement(SourceSkeletonPlaceholder, { style: { width: "30%" } }), import_react27.default.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }));
var Source = ({ isLoading, error, language, code, dark, format: format2, ...rest }) => {
  if (isLoading)
    return import_react27.default.createElement(SourceSkeleton, null);
  if (error)
    return import_react27.default.createElement(EmptyBlock, null, error);
  let syntaxHighlighter = import_react27.default.createElement(StyledSyntaxHighlighter, { bordered: true, copyable: true, format: format2, language, className: "docblock-source sb-unstyled", ...rest }, code);
  if (typeof dark > "u")
    return syntaxHighlighter;
  let overrideTheme = dark ? themes.dark : themes.light;
  return import_react27.default.createElement(ThemeProvider, { theme: convert(overrideTheme) }, syntaxHighlighter);
};
...
var DocsPageWrapper = ({ children, toc }) => import_react27.default.createElement(DocsWrapper, { className: "sbdocs sbdocs-wrapper" }, import_react27.default.createElement(DocsContent, { className: "sbdocs sbdocs-content" }, children), toc);
...
var Zoom3 = ({ zoom, resetZoom }) => import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(IconButton, { key: "zoomin", onClick: (e) => {
  e.preventDefault(), zoom(0.8);
}, title: "Zoom in" }, import_react27.default.createElement(Icons, { icon: "zoom" })), import_react27.default.createElement(IconButton, { key: "zoomout", onClick: (e) => {
  e.preventDefault(), zoom(1.25);
}, title: "Zoom out" }, import_react27.default.createElement(Icons, { icon: "zoomout" })), import_react27.default.createElement(IconButton, { key: "zoomreset", onClick: (e) => {
  e.preventDefault(), resetZoom();
}, title: "Reset zoom" }, import_react27.default.createElement(Icons, { icon: "zoomreset" })));
var Bar = newStyled(FlexBar)({ position: "absolute", left: 0, right: 0, top: 0, transition: "transform .2s linear" });
var Toolbar = ({ isLoading, storyId, baseUrl, zoom, resetZoom, ...rest }) => import_react27.default.createElement(Bar, { ...rest }, import_react27.default.createElement(import_react27.Fragment, { key: "left" }, isLoading ? [1, 2, 3].map((key) => import_react27.default.createElement(IconButtonSkeleton, { key })) : import_react27.default.createElement(Zoom3, { zoom, resetZoom })));
var ZoomContext = (0, import_react27.createContext)({ scale: 1 });
var { window: globalWindow } = scope;
var IFrame = class extends import_react27.Component {
  constructor() {
    super(...arguments);
    this.iframe = null;
  }
  ...
  render() {
    ...
    return import_react27.default.createElement("iframe", { id, title, src, ...allowFullScreen ? { allow: "fullscreen" } : {}, loading: "lazy", ...rest });
  }
};
...
var InlineStory = (props) => {
  let storyRef = (0, import_react27.useRef)(), [showLoader, setShowLoader] = (0, import_react27.useState)(true), [error, setError] = (0, import_react27.useState)(), { story, height, autoplay, forceInitialArgs, renderStoryToElement } = props;
  ...
  return error ? import_react27.default.createElement("pre", null, import_react27.default.createElement(ErrorFormatter, { error })) : import_react27.default.createElement(import_react27.default.Fragment, null, height ? import_react27.default.createElement("style", null, `#${storyBlockIdFromId(props)} { min-height: ${height}; transform: translateZ(0); overflow: auto }`) : null, showLoader && import_react27.default.createElement(StorySkeleton, null), import_react27.default.createElement("div", { ref: storyRef, id: `${storyBlockIdFromId(props)}-inner`, "data-name": story.name, dangerouslySetInnerHTML: { __html: htmlContents } }));
};
var IFrameStory = ({ story, height = "500px" }) => import_react27.default.createElement("div", { style: { width: "100%", height } }, import_react27.default.createElement(ZoomContext.Consumer, null, ({ scale }) => import_react27.default.createElement(IFrame, { key: "iframe", id: `iframe--${story.id}`, title: story.name, src: getStoryHref(BASE_URL, story.id, { viewMode: "story" }), allowFullScreen: true, scale, style: { width: "100%", height: "100%", border: "0 none" } })));
var Story = (props) => {
  let { inline: inline2 } = props;
  return import_react27.default.createElement("div", { id: storyBlockIdFromId(props), className: "sb-story sb-unstyled", "data-story-block": "true" }, inline2 ? import_react27.default.createElement(InlineStory, { ...props }) : import_react27.default.createElement(IFrameStory, { ...props }));
};
var StorySkeleton = () => import_react27.default.createElement(Loader, null);
...
var getSource = (withSource, expanded, setExpanded) => {
  switch (true) {
    ...
    case expanded:
      return { source: import_react27.default.createElement(StyledSource, { ...withSource, dark: true }), actionItem: { title: "Hide code", className: "docblock-code-toggle docblock-code-toggle--expanded", onClick: () => setExpanded(false) } };
    default:
      return { source: import_react27.default.createElement(StyledSource, { ...withSource, dark: true }), actionItem: { title: "Show code", className: "docblock-code-toggle", onClick: () => setExpanded(true) } };
  }
};
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react27.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react27.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react27.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = scope, copyToClipboard = (0, import_react27.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-CQVDFOW3.js");
  ...
  return import_react27.default.createElement(PreviewContainer, { withSource, withToolbar, ...props, className: previewClasses.join(" ") }, withToolbar && import_react27.default.createElement(PositionedToolbar, { isLoading, border: true, zoom: (z) => setScale(scale * z), resetZoom: () => setScale(1), storyId: getStoryId(children), baseUrl: "./iframe.html" }), import_react27.default.createElement(ZoomContext.Provider, { value: { scale } }, import_react27.default.createElement(Relative, { className: "docs-story", onCopyCapture: withSource && onCopyCapture }, import_react27.default.createElement(ChildrenContainer, { isColumn: isColumn || !Array.isArray(children), columns, layout }, import_react27.default.createElement(Zoom.Element, { scale }, Array.isArray(children) ? children.map((child, i) => import_react27.default.createElement("div", { key: i }, child)) : import_react27.default.createElement("div", null, children))), import_react27.default.createElement(ActionBar, { actionItems }))), withSource && expanded && source);
};
var StyledPreview = newStyled(Preview)(() => ({ ".docs-story": { paddingTop: 32, paddingBottom: 40 } }));
var PreviewSkeleton = () => import_react27.default.createElement(StyledPreview, { isLoading: true, withToolbar: true }, import_react27.default.createElement(StorySkeleton, null));
...
var ArgJsDoc = ({ tags }) => {
  ...
  return !hasDisplayableParams && !hasDisplayableReturns && !hasDisplayableDeprecated ? null : import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(Table, null, import_react27.default.createElement("tbody", null, hasDisplayableDeprecated && import_react27.default.createElement("tr", { key: "deprecated" }, import_react27.default.createElement("td", { colSpan: 2 }, import_react27.default.createElement("strong", null, "Deprecated"), ": ", tags.deprecated)), hasDisplayableParams && params.map((x) => import_react27.default.createElement("tr", { key: x.name }, import_react27.default.createElement("td", null, import_react27.default.createElement("code", null, x.name)), import_react27.default.createElement("td", null, x.description))), hasDisplayableReturns && import_react27.default.createElement("tr", { key: "returns" }, import_react27.default.createElement("td", null, import_react27.default.createElement("code", null, "Returns")), import_react27.default.createElement("td", null, tags.returns.description)))));
};
...
var EmptyArg = () => import_react27.default.createElement("span", null, "-");
var ArgText = ({ text, simple }) => import_react27.default.createElement(Text, { simple }, text);
...
var renderSummaryItems = (summaryItems, isExpanded = true) => {
  ...
  return isExpanded || (items = summaryItems.slice(0, ITEMS_BEFORE_EXPANSION)), items.map((item) => import_react27.default.createElement(ArgText, { key: item, text: item === "" ? '""' : item }));
};
var ArgSummary = ({ value: value2, initialExpandedArgs }) => {
  let { summary, detail } = value2, [isOpen, setIsOpen] = (0, import_react27.useState)(false), [isExpanded, setIsExpanded] = (0, import_react27.useState)(initialExpandedArgs || false);
  if (summary == null)
    return null;
  let summaryAsString = typeof summary.toString == "function" ? summary.toString() : summary;
  if (detail == null) {
    if (/[(){}[\]<>]/.test(summaryAsString))
      return import_react27.default.createElement(ArgText, { text: summaryAsString });
    let summaryItems = getSummaryItems(summaryAsString), itemsCount = summaryItems.length;
    return itemsCount > ITEMS_BEFORE_EXPANSION ? import_react27.default.createElement(Summary, { isExpanded }, renderSummaryItems(summaryItems, isExpanded), import_react27.default.createElement(ExpandButton, { onClick: () => setIsExpanded(!isExpanded) }, isExpanded ? "Show less..." : `Show ${itemsCount - ITEMS_BEFORE_EXPANSION} more...`)) : import_react27.default.createElement(Summary, null, renderSummaryItems(summaryItems));
  }
  return import_react27.default.createElement(WithTooltipPure, { closeOnOutsideClick: true, placement: "bottom", visible: isOpen, onVisibleChange: (isVisible) => {
    setIsOpen(isVisible);
  }, tooltip: import_react27.default.createElement(Detail, { width: calculateDetailWidth(detail) }, import_react27.default.createElement(SyntaxHighlighter2, { language: "jsx", format: false }, detail)) }, import_react27.default.createElement(Expandable, { className: "sbdocs-expandable" }, import_react27.default.createElement("span", null, summaryAsString), import_react27.default.createElement(ArrowIcon, { icon: isOpen ? "arrowup" : "arrowdown" })));
};
var ArgValue = ({ value: value2, initialExpandedArgs }) => value2 == null ? import_react27.default.createElement(EmptyArg, null) : import_react27.default.createElement(ArgSummary, { value: value2, initialExpandedArgs });
...
var BooleanControl = ({ name, value: value2, onChange, onBlur, onFocus }) => {
  let onSetFalse = (0, import_react27.useCallback)(() => onChange(false), [onChange]);
  if (value2 === void 0)
    return import_react27.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onSetFalse }, "Set boolean");
  let controlId = getControlId(name), parsedValue = typeof value2 == "string" ? parse2(value2) : value2;
  return import_react27.default.createElement(Label, { htmlFor: controlId, title: parsedValue ? "Change to false" : "Change to true" }, import_react27.default.createElement("input", { id: controlId, type: "checkbox", onChange: (e) => onChange(e.target.checked), checked: parsedValue, name, onBlur, onFocus }), import_react27.default.createElement("span", null, "False"), import_react27.default.createElement("span", null, "True"));
};
...
var DateControl = ({ name, value: value2, onChange, onFocus, onBlur }) => {
  let [valid, setValid] = (0, import_react27.useState)(true), dateRef = (0, import_react27.useRef)(), timeRef = (0, import_react27.useRef)();
  (0, import_react27.useEffect)(() => {
  ...
  return import_react27.default.createElement(FlexSpaced, null, import_react27.default.createElement(Form.Input, { type: "date", max: "9999-12-31", ref: dateRef, id: `${controlId}-date`, name: `${controlId}-date`, onChange: onDateChange, onFocus, onBlur }), import_react27.default.createElement(Form.Input, { type: "time", id: `${controlId}-time`, name: `${controlId}-time`, ref: timeRef, onChange: onTimeChange, onFocus, onBlur }), valid ? null : import_react27.default.createElement("div", null, "invalid"));
};
...
var NumberControl = ({ name, value: value2, onChange, min: min2, max: max2, step, onBlur, onFocus }) => {
  let [inputValue, setInputValue] = (0, import_react27.useState)(typeof value2 == "number" ? value2 : ""), [forceVisible, setForceVisible] = (0, import_react27.useState)(false), [parseError, setParseError] = (0, import_react27.useState)(null), handleChange = (0, import_react27.useCallback)((event) => {
  ...
  }, [onChange, setParseError]), onForceVisible = (0, import_react27.useCallback)(() => {
    setInputValue("0"), onChange(0), setForceVisible(true);
  }, [setForceVisible]), htmlElRef = (0, import_react27.useRef)(null);
  return (0, import_react27.useEffect)(() => {
    forceVisible && htmlElRef.current && htmlElRef.current.select();
  }, [forceVisible]), (0, import_react27.useEffect)(() => {
    inputValue !== (typeof value2 == "number" ? value2 : "") && setInputValue(value2);
  }, [value2]), !forceVisible && value2 === void 0 ? import_react27.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set number") : import_react27.default.createElement(Wrapper2, null, import_react27.default.createElement(Form.Input, { ref: htmlElRef, id: getControlId(name), type: "number", onChange: handleChange, size: "flex", placeholder: "Edit number...", value: inputValue, valid: parseError ? "error" : null, autoFocus: forceVisible, name, min: min2, max: max2, step, onFocus, onBlur }));
};
...
var CheckboxControl = ({ name, options, value: value2, onChange, isInline }) => {
  if (!options)
    return import_client_logger.logger.warn(`Checkbox with no options: ${name}`), import_react27.default.createElement(import_react27.default.Fragment, null, "-");
  let initial = selectedKeys(value2, options), [selected, setSelected] = (0, import_react27.useState)(initial), handleChange = (e) => {
  ...
  return import_react27.default.createElement(Wrapper3, { isInline }, Object.keys(options).map((key, index2) => {
    let id = `${controlId}-${index2}`;
    return import_react27.default.createElement(Label2, { key: id, htmlFor: id }, import_react27.default.createElement("input", { type: "checkbox", id, name: id, value: key, onChange: handleChange, checked: selected == null ? void 0 : selected.includes(key) }), import_react27.default.createElement(Text2, null, key));
  }));
};
...
var RadioControl = ({ name, options, value: value2, onChange, isInline }) => {
  if (!options)
    return import_client_logger.logger.warn(`Radio with no options: ${name}`), import_react27.default.createElement(import_react27.default.Fragment, null, "-");
  let selection = selectedKey(value2, options), controlId = getControlId(name);
  return import_react27.default.createElement(Wrapper4, { isInline }, Object.keys(options).map((key, index2) => {
    let id = `${controlId}-${index2}`;
    return import_react27.default.createElement(Label3, { key: id, htmlFor: id }, import_react27.default.createElement("input", { type: "radio", id, name: id, value: key, onChange: (e) => onChange(options[e.currentTarget.value]), checked: key === selection }), import_react27.default.createElement(Text3, null, key));
  }));
};
...
var SingleSelect = ({ name, value: value2, options, onChange }) => {
  ...
  return import_react27.default.createElement(SelectWrapper, null, import_react27.default.createElement(Icons, { icon: "arrowdown" }), import_react27.default.createElement(OptionsSelect, { id: controlId, value: selection, onChange: handleChange }, import_react27.default.createElement("option", { key: "no-selection", disabled: true }, NO_SELECTION), Object.keys(options).map((key) => import_react27.default.createElement("option", { key }, key))));
};
var MultiSelect = ({ name, value: value2, options, onChange }) => {
  ...
  return import_react27.default.createElement(SelectWrapper, null, import_react27.default.createElement(OptionsSelect, { id: controlId, multiple: true, value: selection, onChange: handleChange }, Object.keys(options).map((key) => import_react27.default.createElement("option", { key }, key))));
};
var SelectControl = (props) => {
  let { name, options } = props;
  return options ? props.isMulti ? import_react27.default.createElement(MultiSelect, { ...props }) : import_react27.default.createElement(SingleSelect, { ...props }) : (import_client_logger.logger.warn(`Select with no options: ${name}`), import_react27.default.createElement(import_react27.default.Fragment, null, "-"));
};
...
var OptionsControl = (props) => {
  ...
  if (Control)
    return import_react27.default.createElement(Control, { ...normalized });
...
var JsonAddValue = class extends import_react27.Component {
  constructor(props) {
  ...
  render() {
    let { handleCancel, onlyValue, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep } = this.props, addButtonElementLayout = (0, import_react27.cloneElement)(addButtonElement, { onClick: this.onSubmit }), cancelButtonElementLayout = (0, import_react27.cloneElement)(cancelButtonElement, { onClick: handleCancel }), inputElementValue = inputElementGenerator(VALUE, keyPath, deep), inputElementValueLayout = (0, import_react27.cloneElement)(inputElementValue, { placeholder: "Value", ref: this.refInputValue }), inputElementKeyLayout = null;
    if (!onlyValue) {
      let inputElementKey = inputElementGenerator(KEY, keyPath, deep);
      inputElementKeyLayout = (0, import_react27.cloneElement)(inputElementKey, { placeholder: "Key", ref: this.refInputKey });
    }
    return import_react27.default.createElement("span", { className: "rejt-add-value-node" }, inputElementKeyLayout, inputElementValueLayout, cancelButtonElementLayout, addButtonElementLayout);
  }
};
JsonAddValue.defaultProps = { onlyValue: false, addButtonElement: import_react27.default.createElement("button", null, "+"), cancelButtonElement: import_react27.default.createElement("button", null, "c") };
var JsonArray = class extends import_react27.Component {
  constructor(props) {
    super(props);
  ...
  renderCollapsed() {
    let { name, data, keyPath, deep } = this.state, { handleRemove, readOnly, getStyle, dataType, minusMenuElement } = this.props, { minus, collapsed } = getStyle(name, data, keyPath, deep, dataType), isReadOnly = readOnly(name, data, keyPath, deep, dataType), removeItemButton = (0, import_react27.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus });
    return import_react27.default.createElement("span", { className: "rejt-collapsed" }, import_react27.default.createElement("span", { className: "rejt-collapsed-text", style: collapsed, onClick: this.handleCollapseMode }, "[...] ", data.length, " ", data.length === 1 ? "item" : "items"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name, data, keyPath, deep, addFormVisible, nextDeep } = this.state, { isCollapsed, handleRemove, onDeltaUpdate, readOnly, getStyle, dataType, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser } = this.props, { minus, plus, delimiter, ul, addForm } = getStyle(name, data, keyPath, deep, dataType), isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = (0, import_react27.cloneElement)(plusMenuElement, { onClick: this.handleAddMode, className: "rejt-plus-menu", style: plus }), removeItemButton = (0, import_react27.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus }), onlyValue = true, startObject = "[", endObject = "]";
    return import_react27.default.createElement("span", { className: "rejt-not-collapsed" }, import_react27.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, startObject), !addFormVisible && addItemButton, import_react27.default.createElement("ul", { className: "rejt-not-collapsed-list", style: ul }, data.map((item, index2) => import_react27.default.createElement(JsonNode, { key: index2, name: index2.toString(), data: item, keyPath, deep: nextDeep, isCollapsed, handleRemove: this.handleRemoveItem(index2), handleUpdateValue: this.handleEditValue, onUpdate: this.onChildUpdate, onDeltaUpdate, readOnly, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser }))), !isReadOnly && addFormVisible && import_react27.default.createElement("div", { className: "rejt-add-form", style: addForm }, import_react27.default.createElement(JsonAddValue, { handleAdd: this.handleAddValueAdd, handleCancel: this.handleAddValueCancel, onlyValue, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep, onSubmitValueParser })), import_react27.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, endObject), !isReadOnly && removeItemButton);
  }
  render() {
    ...
    return import_react27.default.createElement("div", { className: "rejt-array-node" }, import_react27.default.createElement("span", { onClick: this.handleCollapseMode }, import_react27.default.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " ")), value2);
  }
};
JsonArray.defaultProps = { keyPath: [], deep: 0, minusMenuElement: import_react27.default.createElement("span", null, " - "), plusMenuElement: import_react27.default.createElement("span", null, " + ") };
var JsonFunctionValue = class extends import_react27.Component {
  constructor(props) {
    super(props);
    let keyPath = [...props.keyPath, props.name];
  ...
  render() {
    ...
    if (editEnabled && !resultOnlyResult) {
      let textareaElement = textareaElementGenerator(VALUE, comeFromKeyPath, deep, name, originalValue, dataType), editButtonElementLayout = (0, import_react27.cloneElement)(editButtonElement, { onClick: this.handleEdit }), cancelButtonElementLayout = (0, import_react27.cloneElement)(cancelButtonElement, { onClick: this.handleCancelEdit }), textareaElementLayout = (0, import_react27.cloneElement)(textareaElement, { ref: this.refInput, defaultValue: originalValue });
      result = import_react27.default.createElement("span", { className: "rejt-edit-form", style: style.editForm }, textareaElementLayout, " ", cancelButtonElementLayout, editButtonElementLayout), minusElement = null;
    } else {
      result = import_react27.default.createElement("span", { className: "rejt-value", style: style.value, onClick: resultOnlyResult ? null : this.handleEditMode }, value2);
      let minusMenuLayout = (0, import_react27.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: style.minus });
      minusElement = resultOnlyResult ? null : minusMenuLayout;
    }
    return import_react27.default.createElement("li", { className: "rejt-function-value-node", style: style.li }, import_react27.default.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " "), result, minusElement);
  }
};
JsonFunctionValue.defaultProps = { keyPath: [], deep: 0, handleUpdateValue: () => {
}, editButtonElement: import_react27.default.createElement("button", null, "e"), cancelButtonElement: import_react27.default.createElement("button", null, "c"), minusMenuElement: import_react27.default.createElement("span", null, " - ") };
var JsonNode = class extends import_react27.Component {
  constructor(props) {
  ...
  render() {
    ...
    switch (dataType) {
      case ERROR:
        return import_react27.default.createElement(JsonObject, { data, name, isCollapsed, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate, readOnly: readOnlyTrue, dataType, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser });
      case OBJECT:
        return import_react27.default.createElement(JsonObject, { data, name, isCollapsed, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate, readOnly, dataType, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser });
      case ARRAY:
        return import_react27.default.createElement(JsonArray, { data, name, isCollapsed, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate, readOnly, dataType, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser });
      case STRING:
        return import_react27.default.createElement(JsonValue, { name, value: `"${data}"`, originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case NUMBER:
        return import_react27.default.createElement(JsonValue, { name, value: data, originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case BOOLEAN:
        return import_react27.default.createElement(JsonValue, { name, value: data ? "true" : "false", originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case DATE:
        return import_react27.default.createElement(JsonValue, { name, value: data.toISOString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly: readOnlyTrue, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case NULL:
        return import_react27.default.createElement(JsonValue, { name, value: "null", originalValue: "null", keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case UNDEFINED:
        return import_react27.default.createElement(JsonValue, { name, value: "undefined", originalValue: "undefined", keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case FUNCTION:
        return import_react27.default.createElement(JsonFunctionValue, { name, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, textareaElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case SYMBOL:
        return import_react27.default.createElement(JsonValue, { name, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly: readOnlyTrue, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      default:
        return null;
    }
  }
...
var JsonObject = class extends import_react27.Component {
  constructor(props) {
    super(props);
  ...
  renderCollapsed() {
    let { name, keyPath, deep, data } = this.state, { handleRemove, readOnly, dataType, getStyle, minusMenuElement } = this.props, { minus, collapsed } = getStyle(name, data, keyPath, deep, dataType), keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), removeItemButton = (0, import_react27.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus });
    return import_react27.default.createElement("span", { className: "rejt-collapsed" }, import_react27.default.createElement("span", { className: "rejt-collapsed-text", style: collapsed, onClick: this.handleCollapseMode }, "{...}", " ", keyList.length, " ", keyList.length === 1 ? "key" : "keys"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name, data, keyPath, deep, nextDeep, addFormVisible } = this.state, { isCollapsed, handleRemove, onDeltaUpdate, readOnly, getStyle, dataType, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser } = this.props, { minus, plus, addForm, ul, delimiter } = getStyle(name, data, keyPath, deep, dataType), keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = (0, import_react27.cloneElement)(plusMenuElement, { onClick: this.handleAddMode, className: "rejt-plus-menu", style: plus }), removeItemButton = (0, import_react27.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus }), list = keyList.map((key) => import_react27.default.createElement(JsonNode, { key, name: key, data: data[key], keyPath, deep: nextDeep, isCollapsed, handleRemove: this.handleRemoveValue(key), handleUpdateValue: this.handleEditValue, onUpdate: this.onChildUpdate, onDeltaUpdate, readOnly, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser })), startObject = "{", endObject = "}";
    return import_react27.default.createElement("span", { className: "rejt-not-collapsed" }, import_react27.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, startObject), !isReadOnly && addItemButton, import_react27.default.createElement("ul", { className: "rejt-not-collapsed-list", style: ul }, list), !isReadOnly && addFormVisible && import_react27.default.createElement("div", { className: "rejt-add-form", style: addForm }, import_react27.default.createElement(JsonAddValue, { handleAdd: this.handleAddValueAdd, handleCancel: this.handleAddValueCancel, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep, onSubmitValueParser })), import_react27.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, endObject), !isReadOnly && removeItemButton);
  }
  render() {
    ...
    return import_react27.default.createElement("div", { className: "rejt-object-node" }, import_react27.default.createElement("span", { onClick: this.handleCollapseMode }, import_react27.default.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " ")), value2);
  }
};
JsonObject.defaultProps = { keyPath: [], deep: 0, minusMenuElement: import_react27.default.createElement("span", null, " - "), plusMenuElement: import_react27.default.createElement("span", null, " + ") };
var JsonValue = class extends import_react27.Component {
  constructor(props) {
    super(props);
    let keyPath = [...props.keyPath, props.name];
    this.state = { value: props.value, name: props.name, keyPath, deep: props.deep, editEnabled: false, inputRef: null }, this.handleEditMode = this.handleEditMode.bind(this), this.refInput = this.refInput.bind(this), this.handleCancelEdit = this.handleCancelEdit.bind(this), this.handleEdit = this.handleEdit.bind(this), this.onKeydown = this.onKeydown.bind(this);
  ...
  render() {
    let { name, value: value2, editEnabled, keyPath, deep } = this.state, { handleRemove, originalValue, readOnly, dataType, getStyle, editButtonElement, cancelButtonElement, inputElementGenerator, minusMenuElement, keyPath: comeFromKeyPath } = this.props, style = getStyle(name, originalValue, keyPath, deep, dataType), isReadOnly = readOnly(name, originalValue, keyPath, deep, dataType), isEditing = editEnabled && !isReadOnly, inputElement = inputElementGenerator(VALUE, comeFromKeyPath, deep, name, originalValue, dataType), editButtonElementLayout = (0, import_react27.cloneElement)(editButtonElement, { onClick: this.handleEdit }), cancelButtonElementLayout = (0, import_react27.cloneElement)(cancelButtonElement, { onClick: this.handleCancelEdit }), inputElementLayout = (0, import_react27.cloneElement)(inputElement, { ref: this.refInput, defaultValue: JSON.stringify(originalValue) }), minusMenuLayout = (0, import_react27.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: style.minus });
    return import_react27.default.createElement("li", { className: "rejt-value-node", style: style.li }, import_react27.default.createElement("span", { className: "rejt-name", style: style.name }, name, " : "), isEditing ? import_react27.default.createElement("span", { className: "rejt-edit-form", style: style.editForm }, inputElementLayout, " ", cancelButtonElementLayout, editButtonElementLayout) : import_react27.default.createElement("span", { className: "rejt-value", style: style.value, onClick: isReadOnly ? null : this.handleEditMode }, String(value2)), !isReadOnly && !isEditing && minusMenuLayout);
  }
};
JsonValue.defaultProps = { keyPath: [], deep: 0, handleUpdateValue: () => Promise.resolve(), editButtonElement: import_react27.default.createElement("button", null, "e"), cancelButtonElement: import_react27.default.createElement("button", null, "c"), minusMenuElement: import_react27.default.createElement("span", null, " - ") };
...
var JsonTree = class extends import_react27.Component {
  constructor(props) {
...
} }, onSubmitValueParser: (isEditMode, keyPath, deep, name, rawValue) => parse3(rawValue), inputElement: () => import_react27.default.createElement("input", null), textareaElement: () => import_react27.default.createElement("textarea", null), fallback: null };
...
var ObjectControl = ({ name, value: value2, onChange }) => {
  let theme = useTheme(), data = (0, import_react27.useMemo)(() => value2 && (0, import_cloneDeep.default)(value2), [value2]), hasData = data != null, [showRaw, setShowRaw] = (0, import_react27.useState)(!hasData), [parseError, setParseError] = (0, import_react27.useState)(null), updateRaw = (0, import_react27.useCallback)((raw) => {
    try {
      raw && onChange(JSON.parse(raw)), setParseError(void 0);
    } catch (e) {
      setParseError(e);
    }
  }, [onChange]), [forceVisible, setForceVisible] = (0, import_react27.useState)(false), onForceVisible = (0, import_react27.useCallback)(() => {
    onChange({}), setForceVisible(true);
  }, [setForceVisible]), htmlElRef = (0, import_react27.useRef)(null);
  if ((0, import_react27.useEffect)(() => {
    forceVisible && htmlElRef.current && htmlElRef.current.select();
  }, [forceVisible]), !hasData)
    return import_react27.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set object");
  let rawJSONForm = import_react27.default.createElement(RawInput, { ref: htmlElRef, id: getControlId(name), name, defaultValue: value2 === null ? "" : JSON.stringify(value2, null, 2), onBlur: (event) => updateRaw(event.target.value), placeholder: "Edit JSON string...", autoFocus: forceVisible, valid: parseError ? "error" : null });
  return import_react27.default.createElement(Wrapper5, null, ["Object", "Array"].includes(getObjectType(data)) && import_react27.default.createElement(RawButton, { href: "#", onClick: (e) => {
    e.preventDefault(), setShowRaw((v2) => !v2);
  } }, import_react27.default.createElement(Icons, { icon: showRaw ? "eyeclose" : "eye" }), import_react27.default.createElement("span", null, "RAW")), showRaw ? rawJSONForm : import_react27.default.createElement(JsonTree, { data, rootName: name, onFullyUpdate: onChange, getStyle: getCustomStyleFunction(theme), cancelButtonElement: import_react27.default.createElement(Button3, { type: "button" }, "Cancel"), editButtonElement: import_react27.default.createElement(Button3, { type: "submit" }, "Save"), addButtonElement: import_react27.default.createElement(Button3, { type: "submit", primary: true }, "Save"), plusMenuElement: import_react27.default.createElement(ActionIcon, { icon: "add" }), minusMenuElement: import_react27.default.createElement(ActionIcon, { icon: "subtract" }), inputElement: (_, __, ___, key) => key ? import_react27.default.createElement(Input2, { onFocus: selectValue, onBlur: dispatchEnterKey }) : import_react27.default.createElement(Input2, null), fallback: rawJSONForm }));
};
var RangeInput = newStyled.input(({ theme, min: min2, max: max2, value: value2 }) => ({ "&": { width: "100%", backgroundColor: "transparent", appearance: "none" }, "&::-webkit-slider-runnable-track": { background: theme.base === "light" ? `linear-gradient(to right, 
            ${theme.color.green} 0%, ${theme.color.green} ${(value2 - min2) / (max2 - min2) * 100}%, 
            ${curriedDarken$12(0.02, theme.input.background)} ${(value2 - min2) / (max2 - min2) * 100}%, 
            ${curriedDarken$12(0.02, theme.input.background)} 100%)` : `linear-gradient(to right, 
            ${theme.color.green} 0%, ${theme.color.green} ${(value2 - min2) / (max2 - min2) * 100}%, 
            ${curriedLighten$12(0.02, theme.input.background)} ${(value2 - min2) / (max2 - min2) * 100}%, 
...
var RangeCurrentAndMaxLabel = newStyled(RangeLabel)(({ numberOFDecimalsPlaces, max: max2 }) => ({ width: `${numberOFDecimalsPlaces + max2.toString().length * 2 + 3}ch`, textAlign: "right", flexShrink: 0 }));
...
var RangeControl = ({ name, value: value2, onChange, min: min2 = 0, max: max2 = 100, step = 1, onBlur, onFocus }) => {
  ...
  }, hasValue = value2 !== void 0, numberOFDecimalsPlaces = (0, import_react27.useMemo)(() => getNumberOfDecimalPlaces(step), [step]);
  return import_react27.default.createElement(RangeWrapper, null, import_react27.default.createElement(RangeLabel, null, min2), import_react27.default.createElement(RangeInput, { id: getControlId(name), type: "range", onChange: handleChange, name, value: value2, min: min2, max: max2, step, onFocus, onBlur }), import_react27.default.createElement(RangeCurrentAndMaxLabel, { numberOFDecimalsPlaces, max: max2 }, hasValue ? value2.toFixed(numberOFDecimalsPlaces) : "--", " / ", max2));
};
...
var TextControl = ({ name, value: value2, onChange, onFocus, onBlur, maxLength }) => {
  ...
  }, [forceVisible, setForceVisible] = (0, import_react27.useState)(false), onForceVisible = (0, import_react27.useCallback)(() => {
    onChange(""), setForceVisible(true);
  }, [setForceVisible]);
  if (value2 === void 0)
    return import_react27.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set string");
  let isValid = typeof value2 == "string";
  return import_react27.default.createElement(Wrapper6, null, import_react27.default.createElement(Form.Textarea, { id: getControlId(name), maxLength, onChange: handleChange, size: "flex", placeholder: "Edit string...", autoFocus: forceVisible, valid: isValid ? null : "error", name, value: isValid ? value2 : "", onFocus, onBlur }), maxLength && import_react27.default.createElement(MaxLength, { isMaxed: (value2 == null ? void 0 : value2.length) === maxLength }, (value2 == null ? void 0 : value2.length) ?? 0, " / ", maxLength));
};
...
var FilesControl = ({ onChange, name, accept = "image/*", value: value2 }) => {
  let inputElement = (0, import_react27.useRef)(null);
  ...
  }, [value2, name]), import_react27.default.createElement(FileInput, { ref: inputElement, id: getControlId(name), type: "file", name, multiple: true, onChange: handleFileChange, accept, size: "flex" });
};
var LazyColorControl = (0, import_react27.lazy)(() => import("./Color-6VNJS4EI-PXMT5HPO.js"));
var ColorControl = (props) => import_react27.default.createElement(import_react27.Suspense, { fallback: import_react27.default.createElement("div", null) }, import_react27.default.createElement(LazyColorControl, { ...props }));
...
var NoControl = () => import_react27.default.createElement(import_react27.default.Fragment, null, "-");
var ArgControl = ({ row, arg, updateArgs, isHovered }) => {
  let { key, control } = row, [isFocused, setFocused] = (0, import_react27.useState)(false), [boxedValue, setBoxedValue] = (0, import_react27.useState)({ value: arg });
  (0, import_react27.useEffect)(() => {
    isFocused || setBoxedValue({ value: arg });
  }, [isFocused, arg]);
  let onChange = (0, import_react27.useCallback)((argVal) => (setBoxedValue({ value: argVal }), updateArgs({ [key]: argVal }), argVal), [updateArgs, key]), onBlur = (0, import_react27.useCallback)(() => setFocused(false), []), onFocus = (0, import_react27.useCallback)(() => setFocused(true), []);
  if (!control || control.disable)
    return isHovered ? import_react27.default.createElement(Link2, { href: "https://storybook.js.org/docs/react/essentials/controls", target: "_blank", withArrow: true }, "Setup controls") : import_react27.default.createElement(NoControl, null);
  let props = { name: key, argType: row, value: boxedValue.value, onChange, onBlur, onFocus }, Control = Controls22[control.type] || NoControl;
  return import_react27.default.createElement(Control, { ...props, ...control, controlType: control.type });
};
...
var ArgRow = (props) => {
  var _a;
  let [isHovered, setIsHovered] = (0, import_react27.useState)(false), { row, updateArgs, compact, expandable, initialExpandedArgs } = props, { name, description } = row, table = row.table || {}, type = table.type || row.type, defaultValue = table.defaultValue || row.defaultValue, required = (_a = row.type) == null ? void 0 : _a.required, hasDescription = description != null && description !== "";
  return import_react27.default.createElement("tr", { onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false) }, import_react27.default.createElement(StyledTd, { expandable }, import_react27.default.createElement(Name, null, name), required ? import_react27.default.createElement(Required, { title: "Required" }, "*") : null), compact ? null : import_react27.default.createElement("td", null, hasDescription && import_react27.default.createElement(Description, null, import_react27.default.createElement(index_modern_default, null, description)), table.jsDocTags != null ? import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(TypeWithJsDoc, { hasDescription }, import_react27.default.createElement(ArgValue, { value: type, initialExpandedArgs })), import_react27.default.createElement(ArgJsDoc, { tags: table.jsDocTags })) : import_react27.default.createElement(Type2, { hasDescription }, import_react27.default.createElement(ArgValue, { value: type, initialExpandedArgs }))), compact ? null : import_react27.default.createElement("td", null, import_react27.default.createElement(ArgValue, { value: defaultValue, initialExpandedArgs })), updateArgs ? import_react27.default.createElement("td", null, import_react27.default.createElement(ArgControl, { ...props, isHovered })) : null);
};
...
var SectionRow = ({ level = "section", label, children, initialExpanded = true, colSpan = 3 }) => {
  let [expanded, setExpanded] = (0, import_react27.useState)(initialExpanded), Level = level === "subsection" ? Subsection : Section, itemCount = (children == null ? void 0 : children.length) || 0, caption = level === "subsection" ? `${itemCount} item${itemCount !== 1 ? "s" : ""}` : "", icon = expanded ? "arrowdown" : "arrowright", helperText = `${expanded ? "Hide" : "Show"} ${level === "subsection" ? itemCount : label} item${itemCount !== 1 ? "s" : ""}`;
  return import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(StyledTr, { title: helperText }, import_react27.default.createElement(Level, { colSpan: 1 }, import_react27.default.createElement(ClickIntercept, { onClick: (e) => setExpanded(!expanded), tabIndex: 0 }, helperText), import_react27.default.createElement(FlexWrapper, null, import_react27.default.createElement(ExpanderIcon, { icon }), label)), import_react27.default.createElement(StyledTd2, { colSpan: colSpan - 1 }, import_react27.default.createElement(ClickIntercept, { onClick: (e) => setExpanded(!expanded), tabIndex: -1, style: { outline: "none" } }, helperText), expanded ? null : caption)), expanded ? children : null);
};
...
var Skeleton = () => import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(Row, null, import_react27.default.createElement(Column, { numColumn: columnWidth[0] }, import_react27.default.createElement(SkeletonText, { width: "60%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[1] }, import_react27.default.createElement(SkeletonText, { width: "30%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[2] }, import_react27.default.createElement(SkeletonText, { width: "60%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[3] }, import_react27.default.createElement(SkeletonText, { width: "60%" }))), import_react27.default.createElement(Row, null, import_react27.default.createElement(Column, { numColumn: columnWidth[0] }, import_react27.default.createElement(SkeletonText, { width: "60%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[1] }, import_react27.default.createElement(SkeletonText, { width: "80%" }), import_react27.default.createElement(SkeletonText, { width: "30%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[2] }, import_react27.default.createElement(SkeletonText, { width: "60%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[3] }, import_react27.default.createElement(SkeletonText, { width: "60%" }))), import_react27.default.createElement(Row, null, import_react27.default.createElement(Column, { numColumn: columnWidth[0] }, import_react27.default.createElement(SkeletonText, { width: "60%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[1] }, import_react27.default.createElement(SkeletonText, { width: "80%" }), import_react27.default.createElement(SkeletonText, { width: "30%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[2] }, import_react27.default.createElement(SkeletonText, { width: "60%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[3] }, import_react27.default.createElement(SkeletonText, { width: "60%" }))), import_react27.default.createElement(Row, null, import_react27.default.createElement(Column, { numColumn: columnWidth[0] }, import_react27.default.createElement(SkeletonText, { width: "60%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[1] }, import_react27.default.createElement(SkeletonText, { width: "80%" }), import_react27.default.createElement(SkeletonText, { width: "30%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[2] }, import_react27.default.createElement(SkeletonText, { width: "60%" })), import_react27.default.createElement(Column, { numColumn: columnWidth[3] }, import_react27.default.createElement(SkeletonText, { width: "60%" }))));
...
var VideoIcon = newStyled.div(({ theme }) => ({ width: 22, height: 16, borderRadius: theme.appBorderRadius, border: `1px solid ${theme.color.secondary}`, display: "flex", alignItems: "center", justifyContent: "center" }));
var Empty = ({ inAddonPanel }) => {
  let [isLoading, setIsLoading] = (0, import_react27.useState)(true);
  return (0, import_react27.useEffect)(() => {
    let load = setTimeout(() => {
      setIsLoading(false);
    }, 100);
    return () => clearTimeout(load);
  }, []), isLoading ? null : import_react27.default.createElement(Wrapper7, { inAddonPanel }, import_react27.default.createElement(Content, null, import_react27.default.createElement(Title2, null, inAddonPanel ? "Interactive story playground" : "Args table with interactive controls couldn't be auto-generated"), import_react27.default.createElement(Description2, null, "Controls give you an easy to use interface to test your components. Set your story args and you'll see controls appearing here automatically.")), import_react27.default.createElement(Links, null, inAddonPanel && import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(Link2, { href: "https://youtu.be/0gOfS6K0x0E", target: "_blank", icon: import_react27.default.createElement(VideoIcon, null, import_react27.default.createElement(dist_exports.Play, { size: 8 })), withArrow: true }, "Watch 5m video"), import_react27.default.createElement(Divider, null), import_react27.default.createElement(Link2, { href: "https://storybook.js.org/docs/react/essentials/controls", target: "_blank", withArrow: true }, "Read docs")), !inAddonPanel && import_react27.default.createElement(Link2, { href: "https://storybook.js.org/docs/react/essentials/controls", target: "_blank", withArrow: true }, "Learn how to set that up")));
};
...
var ArgsTable = (props) => {
  ...
  if ("error" in props) {
    let { error } = props;
    return import_react27.default.createElement(EmptyBlock, null, error, " ", import_react27.default.createElement(Link2, { href: "http://storybook.js.org/docs/", target: "_blank", withArrow: true }, "Read the docs"));
  }
  if (isLoading)
    return import_react27.default.createElement(Skeleton, null);
  ...
  if (hasNoUngrouped && hasNoSections && hasNoUngroupedSubsections)
    return import_react27.default.createElement(Empty, { inAddonPanel });
  let colSpan = 1;
  ...
  return import_react27.default.createElement(ResetWrapper, null, import_react27.default.createElement(TableWrapper, { compact, inAddonPanel, className: "docblock-argstable sb-unstyled" }, import_react27.default.createElement("thead", { className: "docblock-argstable-head" }, import_react27.default.createElement("tr", null, import_react27.default.createElement("th", null, import_react27.default.createElement("span", null, "Name")), compact ? null : import_react27.default.createElement("th", null, import_react27.default.createElement("span", null, "Description")), compact ? null : import_react27.default.createElement("th", null, import_react27.default.createElement("span", null, "Default")), updateArgs ? import_react27.default.createElement("th", null, import_react27.default.createElement(ControlHeadingWrapper, null, "Control", " ", !isLoading && resetArgs && import_react27.default.createElement(StyledIconButton, { onClick: () => resetArgs(), title: "Reset controls" }, import_react27.default.createElement(Icons, { icon: "undo", "aria-hidden": true })))) : null)), import_react27.default.createElement("tbody", { className: "docblock-argstable-body" }, groups.ungrouped.map((row) => import_react27.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], ...common })), Object.entries(groups.ungroupedSubsections).map(([subcategory, subsection]) => import_react27.default.createElement(SectionRow, { key: subcategory, label: subcategory, level: "subsection", colSpan }, subsection.map((row) => import_react27.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], expandable, ...common })))), Object.entries(groups.sections).map(([category, section]) => import_react27.default.createElement(SectionRow, { key: category, label: category, level: "section", colSpan }, section.ungrouped.map((row) => import_react27.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], ...common })), Object.entries(section.subsections).map(([subcategory, subsection]) => import_react27.default.createElement(SectionRow, { key: subcategory, label: subcategory, level: "subsection", colSpan }, subsection.map((row) => import_react27.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], expandable, ...common })))))))));
};
var TabbedArgsTable = ({ tabs, ...props }) => {
  let entries = Object.entries(tabs);
  return entries.length === 1 ? import_react27.default.createElement(ArgsTable, { ...entries[0][1], ...props }) : import_react27.default.createElement(TabsState, null, entries.map((entry) => {
    let [label, table] = entry, id = `prop_table_div_${label}`;
    return import_react27.default.createElement("div", { key: id, id, title: label }, ({ active }) => active ? import_react27.default.createElement(ArgsTable, { key: `prop_table_${label}`, ...table, ...props }) : null);
  }));
};
...
var Typeset = ({ fontFamily, fontSizes, fontWeight, sampleText, ...props }) => import_react27.default.createElement(Wrapper8, { ...props, className: "docblock-typeset sb-unstyled" }, fontSizes.map((size2) => import_react27.default.createElement(TypeSpecimen, { key: size2 }, import_react27.default.createElement(Label4, null, size2), import_react27.default.createElement(Sample, { style: { fontFamily, fontSize: size2, fontWeight, lineHeight: 1.2 } }, sampleText || "Was he a beast if music could move him so?"))));
...
function renderSwatch(color, index2) {
  return import_react27.default.createElement(Swatch, { key: `${color}-${index2}`, title: color, background: color });
}
function renderSwatchLabel(color, index2, colorDescription) {
  return import_react27.default.createElement(SwatchLabel, { key: `${color}-${index2}`, title: color }, import_react27.default.createElement("div", null, color, colorDescription && import_react27.default.createElement("span", null, colorDescription)));
}
function renderSwatchSpecimen(colors) {
  return Array.isArray(colors) ? import_react27.default.createElement(SwatchSpecimen, null, import_react27.default.createElement(SwatchColors, null, colors.map((color, index2) => renderSwatch(color, index2))), import_react27.default.createElement(SwatchLabels, null, colors.map((color, index2) => renderSwatchLabel(color, index2)))) : import_react27.default.createElement(SwatchSpecimen, null, import_react27.default.createElement(SwatchColors, null, Object.values(colors).map((color, index2) => renderSwatch(color, index2))), import_react27.default.createElement(SwatchLabels, null, Object.keys(colors).map((color, index2) => renderSwatchLabel(color, index2, colors[color]))));
}
var ColorItem = ({ title, subtitle, colors }) => import_react27.default.createElement(Item, null, import_react27.default.createElement(ItemDescription, null, import_react27.default.createElement(ItemTitle, null, title), import_react27.default.createElement(ItemSubtitle, null, subtitle)), import_react27.default.createElement(Swatches, null, renderSwatchSpecimen(colors)));
var ColorPalette = ({ children, ...props }) => import_react27.default.createElement(ResetWrapper, null, import_react27.default.createElement(List, { ...props, className: "docblock-colorpalette sb-unstyled" }, import_react27.default.createElement(ListHeading, null, import_react27.default.createElement(ListName, null, "Name"), import_react27.default.createElement(ListSwatches, null, "Swatches")), children));
...
var IconItem = ({ name, children }) => import_react27.default.createElement(Item2, null, import_react27.default.createElement(ItemSpecimen, null, children), import_react27.default.createElement(ItemLabel, null, name));
var IconGallery = ({ children, ...props }) => import_react27.default.createElement(ResetWrapper, null, import_react27.default.createElement(List2, { ...props, className: "docblock-icongallery sb-unstyled" }, children));
var anchorBlockIdFromId = (storyId) => `anchor--${storyId}`;
var Anchor = ({ storyId, children }) => import_react27.default.createElement("div", { id: anchorBlockIdFromId(storyId), className: "sb-anchor" }, children);
scope && scope.__DOCS_CONTEXT__ === void 0 && (scope.__DOCS_CONTEXT__ = (0, import_react27.createContext)(null), scope.__DOCS_CONTEXT__.displayName = "DocsContext");
var DocsContext = scope ? scope.__DOCS_CONTEXT__ : (0, import_react27.createContext)(null);
var useOf = (moduleExportOrType, validTypes) => (0, import_react27.useContext)(DocsContext).resolveOf(moduleExportOrType, validTypes);
...
var ArgTypes = (props) => {
  ...
  return import_react27.default.createElement(ArgsTable, { rows: filteredArgTypes, sort });
};
var PRIMARY_STORY = "^";
...
function useStories(storyIds, context) {
  let [storiesById, setStories] = (0, import_react27.useState)({});
  return (0, import_react27.useEffect)(() => {
...
var useArgs = (storyId, context) => {
  let storyContext = context.getStoryContext(context.storyById()), [args, setArgs] = (0, import_react27.useState)(storyContext.args);
  (0, import_react27.useEffect)(() => {
    let cb = (changed) => {
  ...
  let updateArgs = (0, import_react27.useCallback)((updatedArgs) => context.channel.emit(import_core_events.UPDATE_STORY_ARGS, { storyId, updatedArgs }), [storyId]), resetArgs = (0, import_react27.useCallback)((argNames) => context.channel.emit(import_core_events.RESET_STORY_ARGS, { storyId, argNames }), [storyId]);
  return [args, updateArgs, resetArgs];
};
var useGlobals = (context) => {
  let storyContext = context.getStoryContext(context.storyById()), [globals, setGlobals] = (0, import_react27.useState)(storyContext.globals);
  return (0, import_react27.useEffect)(() => {
    let cb = (changed) => {
...
var StoryTable = (props) => {
  let context = (0, import_react27.useContext)(DocsContext), { story: storyName, component, subcomponents, showComponent, include, exclude, sort } = props;
  try {
    let storyId;
    switch (storyName) {
      case PRIMARY_STORY: {
    ...
    if (!story)
      return import_react27.default.createElement(ArgsTable, { isLoading: true, updateArgs, resetArgs });
    ...
    return import_react27.default.createElement(TabbedArgsTable, { tabs, sort });
  } catch (err) {
    return import_react27.default.createElement(ArgsTable, { error: err.message });
  }
};
...
var ArgsTable2 = (props) => {
  ...
  `);
  let context = (0, import_react27.useContext)(DocsContext), parameters, component, subcomponents;
  try {
  ...
  if (storyName)
    return import_react27.default.createElement(StoryTable, { ...props, component: main, subcomponents, sort });
  if (!components22 && !subcomponents) {
    ...
    return import_react27.default.createElement(ArgsTable, { ...mainProps, sort });
  }
  if (components22)
    return import_react27.default.createElement(ComponentsTable, { ...props, components: components22, sort, parameters });
  let mainLabel = getComponentName(main);
  return import_react27.default.createElement(ComponentsTable, { ...props, components: { [mainLabel]: main, ...subcomponents }, sort, parameters });
};
ArgsTable2.defaultProps = { of: PRIMARY_STORY };
function argsHash(args) {
  return stringify(args);
}
var SourceContext = (0, import_react27.createContext)({ sources: {} });
var UNKNOWN_ARGS_HASH = "--unknown--";
var SourceContainer = ({ children, channel }) => {
  let [sources, setSources] = (0, import_react27.useState)({});
  return (0, import_react27.useEffect)(() => {
  ...
  }, []), import_react27.default.createElement(SourceContext.Provider, { value: { sources } }, children);
};
...
var Source2 = (props) => {
  ...
  `), props.ids && (0, import_client_logger.deprecate)(esm_default`The \`ids\` prop on Source is deprecated, please use the \`of\` prop instead to reference a story. 
    ...
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#source-block
  `);
  let sourceContext = (0, import_react27.useContext)(SourceContext), docsContext = (0, import_react27.useContext)(DocsContext), { state, ...sourceProps } = useSourceProps(props, docsContext, sourceContext);
  return import_react27.default.createElement(Source, { ...sourceProps });
};
...
var Story2 = (props = { __forceInitialArgs: false, __primary: false }) => {
  let context = (0, import_react27.useContext)(DocsContext), storyId = getStoryId2(props, context), story = useStory(storyId, context);
  if (!story)
    return import_react27.default.createElement(StorySkeleton, null);
  let storyProps = getStoryProps(props, story, context);
  return storyProps ? import_react27.default.createElement(Story, { ...storyProps }) : null;
};
var useDeprecatedPreviewProps = ({ withSource, mdxSource, children, layout: layoutProp, ...props }, docsContext, sourceContext) => {
  let storyIds = import_react27.Children.toArray(children).filter((c) => c.props && (c.props.id || c.props.name || c.props.of)).map((c) => getStoryId2(c.props, docsContext)), stories = useStories(storyIds, docsContext), isLoading = stories.some((s) => !s), sourceProps = useSourceProps({ ...mdxSource ? { code: decodeURI(mdxSource) } : { ids: storyIds }, ...props.of && { of: props.of } }, docsContext, sourceContext);
  if (withSource === "none")
    return { isLoading, previewProps: props };
  let layout = layoutProp;
  return import_react27.Children.forEach(children, (child) => {
    var _a, _b;
...
var Canvas = (props) => {
  ...
  let docsContext = (0, import_react27.useContext)(DocsContext), sourceContext = (0, import_react27.useContext)(SourceContext), { children, of, source } = props;
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  ...
  if (props.withSource && (0, import_client_logger.deprecate)(esm_default`Setting source state with \`withSource\` is deprecated, please use \`sourceState\` with 'hidden', 'shown' or 'none' instead. 
    ...
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
  `), isLoading ? import_react27.default.createElement(PreviewSkeleton, null) : import_react27.default.createElement(Preview, { ...previewProps }, children);
  ...
  return import_react27.default.createElement(Preview, { withSource: sourceState === "none" ? void 0 : sourceProps, isExpanded: sourceState === "shown", withToolbar, additionalActions, className, layout }, import_react27.default.createElement(Story2, { of: of || story.moduleExport, meta: props.meta, ...props.story }));
};
var useGlobals2 = (story, context) => {
  let storyContext = context.getStoryContext(story), [globals, setGlobals] = (0, import_react27.useState)(storyContext.globals);
  return (0, import_react27.useEffect)(() => {
...
var useArgsIfDefined = (story, context) => {
  let storyContext = story ? context.getStoryContext(story) : { args: {} }, { id: storyId } = story || { id: "none" }, [args, setArgs] = (0, import_react27.useState)(storyContext.args);
  (0, import_react27.useEffect)(() => {
  ...
  let updateArgs = (0, import_react27.useCallback)((updatedArgs) => context.channel.emit(import_core_events.UPDATE_STORY_ARGS, { storyId, updatedArgs }), [storyId, context.channel]), resetArgs = (0, import_react27.useCallback)((argNames) => context.channel.emit(import_core_events.RESET_STORY_ARGS, { storyId, argNames }), [storyId, context.channel]);
...
var AddContext = (props) => {
  let { children, ...rest } = props, parentContext = import_react27.default.useContext(DocsContext);
  return import_react27.default.createElement(DocsContext.Provider, { value: { ...parentContext, ...rest } }, children);
};
var CodeOrSourceMdx = ({ className, children, ...rest }) => {
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return import_react27.default.createElement(Code, null, children);
  let language = className && className.split("-");
  return import_react27.default.createElement(Source, { language: language && language[1] || "plaintext", format: false, code: children, ...rest });
};
...
var AnchorInPage = ({ hash, children }) => {
  let context = (0, import_react27.useContext)(DocsContext);
  return import_react27.default.createElement(A, { href: hash, target: "_self", onClick: (event) => {
    let id = hash.substring(1);
    document2.getElementById(id) && navigate(context, hash);
  } }, children);
};
var AnchorMdx = (props) => {
  let { href, target, children, ...rest } = props, context = (0, import_react27.useContext)(DocsContext);
  if (href) {
    if (href.startsWith("#"))
      return import_react27.default.createElement(AnchorInPage, { hash: href }, children);
    if (target !== "_blank" && !href.startsWith("https://"))
      return import_react27.default.createElement(A, { href, onClick: (event) => {
  ...
  return import_react27.default.createElement(A, { ...props });
};
...
var HeaderWithOcticonAnchor = ({ as, id, children, ...rest }) => {
  let context = (0, import_react27.useContext)(DocsContext), OcticonHeader = OcticonHeaders[as], hash = `#${id}`;
  return import_react27.default.createElement(OcticonHeader, { id, ...rest }, import_react27.default.createElement(OcticonAnchor, { "aria-hidden": "true", href: hash, tabIndex: -1, target: "_self", onClick: (event) => {
    document2.getElementById(id) && navigate(context, hash);
  } }, import_react27.default.createElement(Icons, { icon: "link" })), children);
};
var HeaderMdx = (props) => {
  let { as, id, children, ...rest } = props;
  if (id)
    return import_react27.default.createElement(HeaderWithOcticonAnchor, { as, id, ...rest }, children);
  let Component4 = as, { as: omittedAs, ...withoutAs } = props;
  return import_react27.default.createElement(Component4, { ...nameSpaceClassNames(withoutAs, as) });
};
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce((acc, headerType) => ({ ...acc, [headerType]: (props) => import_react27.default.createElement(HeaderMdx, { as: headerType, ...props }) }), {});
var Markdown2 = (props) => {
  var _a;
  if (!props.children)
    return null;
  if (typeof props.children != "string")
    throw new Error(esm_default`The Markdown block only accepts children as a single string, but children were of type: '${typeof props.children}'
      ...
      `);
  return import_react27.default.createElement(index_modern_default, { ...props, options: { forceBlock: true, overrides: { code: CodeOrSourceMdx, a: AnchorMdx, ...HeadersMdx, ...(_a = props == null ? void 0 : props.options) == null ? void 0 : _a.overrides }, ...props == null ? void 0 : props.options } });
};
...
var DescriptionContainer = (props) => {
  ...
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  let context = (0, import_react27.useContext)(DocsContext), resolvedOf = useOf(of || "meta"), markdown;
  return type || markdownProp || children ? markdown = getDescriptionFromDeprecatedProps(props, context) : markdown = getDescriptionFromResolvedOf(resolvedOf), type && (0, import_client_logger.deprecate)(`Manually specifying description type is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), markdownProp && (0, import_client_logger.deprecate)(`The 'markdown' prop on the Description block is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), children && (0, import_client_logger.deprecate)(`The 'children' prop on the Description block is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), markdown ? import_react27.default.createElement(Markdown2, null, markdown) : null;
};
...
var OptionalTitle = ({ title }) => title === null ? null : typeof title == "string" ? import_react27.default.createElement(Heading, null, title) : title;
var TableOfContents = ({ title, disable, headingSelector, contentsSelector, ignoreSelector, unsafeTocbotOptions }) => ((0, import_react27.useEffect)(() => {
...
}, [disable]), import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(Wrapper9, null, disable ? null : import_react27.default.createElement(Content2, null, import_react27.default.createElement(OptionalTitle, { title: title || null }), import_react27.default.createElement("div", { className: "toc-wrapper" })))));
...
var DocsContainer = ({ context, theme, children }) => {
  ...
  }), import_react27.default.createElement(DocsContext.Provider, { value: context }, import_react27.default.createElement(SourceContainer, { channel: context.channel }, import_react27.default.createElement(ThemeProvider, { theme: ensure(theme) }, import_react27.default.createElement(DocsPageWrapper, { toc: toc ? import_react27.default.createElement(TableOfContents, { className: "sbdocs sbdocs-toc--custom", ...toc }) : null }, children))));
};
...
var Title3 = ({ children }) => {
  let context = (0, import_react27.useContext)(DocsContext), content = children || extractTitle(context.storyById().title);
  return content ? import_react27.default.createElement(Title, { className: "sbdocs-title sb-unstyled" }, content) : null;
};
var Subtitle2 = ({ children }) => {
  let docsContext = (0, import_react27.useContext)(DocsContext), { parameters } = docsContext.storyById(), content = children || (parameters == null ? void 0 : parameters.componentSubtitle);
  return content ? import_react27.default.createElement(Subtitle, { className: "sbdocs-subtitle sb-unstyled" }, content) : null;
};
var Subheading = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return import_react27.default.createElement(H3, null, children);
  let tagID = children.toLowerCase().replace(/[^a-z0-9]/gi, "-");
  return import_react27.default.createElement(HeaderMdx, { as: "h3", id: tagID }, children);
};
var DocsStory = ({ of, expanded = true, withToolbar: withToolbarProp = false, __forceInitialArgs = false, __primary = false }) => {
  ...
  return import_react27.default.createElement(Anchor, { storyId: story.id }, expanded && import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(Subheading, null, story.name), import_react27.default.createElement(DescriptionContainer, { of })), import_react27.default.createElement(Canvas, { of, withToolbar, story: { __forceInitialArgs, __primary }, source: { __forceInitialArgs } }));
};
var Primary = ({ name }) => {
  let docsContext = (0, import_react27.useContext)(DocsContext);
  ...
  return story ? import_react27.default.createElement(DocsStory, { of: story.moduleExport, expanded: false, __primary: true, withToolbar: true }) : null;
};
var Heading2 = ({ children, disableAnchor, ...props }) => {
  if (disableAnchor || typeof children != "string")
    return import_react27.default.createElement(H2, null, children);
  let tagID = children.toLowerCase().replace(/[^a-z0-9]/gi, "-");
  return import_react27.default.createElement(HeaderMdx, { as: "h2", id: tagID, ...props }, children);
};
...
var Stories = ({ title, includePrimary = true }) => {
  let { componentStories } = (0, import_react27.useContext)(DocsContext), stories = componentStories().filter((story) => {
    var _a, _b;
    return !((_b = (_a = story.parameters) == null ? void 0 : _a.docs) == null ? void 0 : _b.disable);
  });
  return includePrimary || (stories = stories.slice(1)), !stories || stories.length === 0 ? null : import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(StyledHeading, null, title), stories.map((story) => story && import_react27.default.createElement(DocsStory, { key: story.id, of: story.moduleExport, expanded: true, __forceInitialArgs: true })));
};
...
var DocsPage = () => {
  ...
  return import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(Title3, null), import_react27.default.createElement(Subtitle2, null), import_react27.default.createElement(DescriptionContainer, { of: "meta" }), isSingleStory ? import_react27.default.createElement(DescriptionContainer, { of: "story" }) : null, import_react27.default.createElement(Primary, null), import_react27.default.createElement(Controls3, null), isSingleStory ? null : import_react27.default.createElement(Stories, null));
};
function Docs({ context, docsParameter }) {
  let Container = docsParameter.container || DocsContainer, Page = docsParameter.page || DocsPage;
  return import_react27.default.createElement(Container, { context, theme: docsParameter.theme }, import_react27.default.createElement(Page, null));
}
...
function usePreview(projectAnnotations) {
  let previewRef = (0, import_react27.useRef)();
...
function ExternalDocs({ projectAnnotationsList, children }) {
  ...
  return import_react27.default.createElement(Docs, { docsParameter, context: preview2.docsContext() });
}
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => (preview || (preview = new ExternalPreview(projectAnnotations)), import_react27.default.createElement(DocsContext.Provider, { value: preview.docsContext() }, import_react27.default.createElement(ThemeProvider, { theme: ensure(themes.light) }, children)));
var Meta = ({ of }) => {
  let context = (0, import_react27.useContext)(DocsContext);
  of && context.referenceMeta(of, true);
  try {
    let primary = context.storyById();
    return import_react27.default.createElement(Anchor, { storyId: primary.id });
  } catch {
    return null;
  }
};
var Unstyled = (props) => import_react27.default.createElement("div", { ...props, className: "sb-unstyled" });
var Wrapper10 = ({ children }) => import_react27.default.createElement("div", { style: { fontFamily: "sans-serif" } }, children);
...
//# sourceMappingURL=chunk-ROG5O4VO.js.map
